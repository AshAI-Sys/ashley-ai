...
console.log(
  `📊 Original size: ${originalSizeMB} MB (${originalStats.size.toLocaleString()} bytes)`
);
...
try {
  ...
  execSync(
    `pngcrush -rem allb -reduce -brute "${INPUT_FILE}" "${OUTPUT_FILE}"`,
    {
      stdio: "pipe",
      timeout: 30000,
    }
...
if (optimized && fs.existsSync(OUTPUT_FILE)) {
  ...
  console.log(
    `💾 Saved:     ${(originalStats.size - optimizedStats.size) / (1024 * 1024).toFixed(2)} MB`
  );
  console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
  console.log("\n📂 Files:");
  ...
  console.log(
    "If yes, run: mv uploads/Ash_Logo_optimized.png uploads/Ash_Logo.png\n"
  );
}
