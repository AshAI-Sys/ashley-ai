...
export type OrderStatus = "draft" | "pending_approval" | "approved" | "in_production" | "completed" | "cancelled";
...
export type ShipmentStatus = "pending" | "confirmed" | "ready_for_pickup" | "in_transit" | "out_for_delivery" | "delivered" | "cancelled" | "failed";
export type DeliveryMethod = "DRIVER" | "LALAMOVE" | "GRAB" | "JNT" | "LBC" | "NINJAVAN" | "DHL";
...
export type InvoiceStatus = "draft" | "pending" | "sent" | "paid" | "partially_paid" | "overdue" | "cancelled";
export type PaymentMethod = "cash" | "bank_transfer" | "credit_card" | "check" | "online_payment";
 ...
 */
export declare function isPaginatedResponse<T>(data: any): data is PaginatedResponse<T>;
