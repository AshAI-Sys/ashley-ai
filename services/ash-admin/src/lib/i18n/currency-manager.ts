...
export class CurrencyManager {
  private readonly CURRENCIES: Record<SupportedCurrency, CurrencyConfig> = {
    PHP: { code: 'PHP', name: 'Philippine Peso', symbol: '₱', decimal_digits: 2, format: 'before' },
    USD: { code: 'USD', name: 'US Dollar', symbol: '$', decimal_digits: 2, format: 'before' },
    EUR: { code: 'EUR', name: 'Euro', symbol: '€', decimal_digits: 2, format: 'before' },
    GBP: { code: 'GBP', name: 'British Pound', symbol: '£', decimal_digits: 2, format: 'before' },
    JPY: { code: 'JPY', name: 'Japanese Yen', symbol: '¥', decimal_digits: 0, format: 'before' },
    CNY: { code: 'CNY', name: 'Chinese Yuan', symbol: '¥', decimal_digits: 2, format: 'before' },
    INR: { code: 'INR', name: 'Indian Rupee', symbol: '₹', decimal_digits: 2, format: 'before' },
    AUD: { code: 'AUD', name: 'Australian Dollar', symbol: 'A$', decimal_digits: 2, format: 'before' },
    CAD: { code: 'CAD', name: 'Canadian Dollar', symbol: 'C$', decimal_digits: 2, format: 'before' },
    SGD: { code: 'SGD', name: 'Singapore Dollar', symbol: 'S$', decimal_digits: 2, format: 'before' },
  };
