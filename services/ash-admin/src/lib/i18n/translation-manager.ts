...
export class TranslationManager {
  private readonly LANGUAGES: Record<SupportedLanguage, LanguageConfig> = {
    ...
    tl: { code: 'tl', name: 'Tagalog', native_name: 'Tagalog', direction: 'ltr' },
    zh: { code: 'zh', name: 'Chinese', native_name: '中文', direction: 'ltr' },
    es: { code: 'es', name: 'Spanish', native_name: 'Español', direction: 'ltr' },
    ja: { code: 'ja', name: 'Japanese', native_name: '日本語', direction: 'ltr' },
    ko: { code: 'ko', name: 'Korean', native_name: '한국어', direction: 'ltr' },
    fr: { code: 'fr', name: 'French', native_name: 'Français', direction: 'ltr' },
    de: { code: 'de', name: 'German', native_name: 'Deutsch', direction: 'ltr' },
  };
