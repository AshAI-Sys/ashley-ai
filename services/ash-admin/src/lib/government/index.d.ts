...
export type { GovernmentAgency, BIRSalesBookEntry, BIRPurchaseBookEntry, BIRWithholdingTax, BIR2307Form, SSSContribution, SSSContributionTable, SSSRemittanceReport, PhilHealthContribution, PhilHealthContributionTable, PhilHealthRemittanceReport, PagIBIGContribution, PagIBIGContributionTable, PagIBIGRemittanceReport, ExportOptions, GovernmentReport, } from "./types";
/**
