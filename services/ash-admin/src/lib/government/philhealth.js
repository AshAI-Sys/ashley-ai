...
exports.philHealthService = exports.PhilHealthService = void 0;
/**
...
class PhilHealthService {
    constructor() {
        ...
        this.PREMIUM_RATE = 0.05; // 5% of monthly salary
        this.MIN_SALARY = 10000; // Minimum monthly salary credit
        this.MAX_SALARY = 100000; // Maximum monthly salary credit
        this.MIN_PREMIUM = 500; // Minimum monthly premium (5% of 10,000)
        this.MAX_PREMIUM = 5000; // Maximum monthly premium (5% of 100,000)
    }
    /**
    ...
    getContributionTable() {
        ...
        for (let salary = this.MIN_SALARY; salary <= this.MAX_SALARY; salary += 5000) {
    ...
    async generateRemittanceReport(period, employer, employees) {
        ...
        const total_premium = contributions.reduce((sum, c) => sum + c.premium_contribution, 0);
     ...
     */
    validatePhilHealthNumber(philhealthNumber) {
     ...
     */
    formatPhilHealthNumber(philhealthNumber) {
        const cleaned = philhealthNumber.replace(/-/g, "");
     ...
     */
    calculateAnnualPremium(monthlySalary) {
...
exports.philHealthService = new PhilHealthService();
