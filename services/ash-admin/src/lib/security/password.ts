...
const COMMON_PASSWORDS = new Set([
  ...
  'sunshine', 'master', 'welcomeback', 'shadow', 'ashley', 'football', 'jesus', 'michael',
  'ninja', 'mustang', 'password1', '000000', 'admin', 'letmein', 'monkey', '654321',
  'starwars', 'charlie', 'aa123456', 'donald', 'password123', 'qwerty123', 'zxcvbnm',
  'welcome', 'login', 'solo', 'abc123', 'admin123', 'flower', 'passw0rd', 'killer',
  'changeme', 'hello', '123qwe', 'bailey', 'access', 'passw0rd', 'superman', 'qazwsx'
])
