...
function canCreate(user, _context) {
    // If no permissions are provided, get them from the role
    let userPermissions = user.permissions;
    if (!userPermissions || userPermissions.length === 0) {
        const { getRoleBasedPermissions } = require("./rbac");
...
function canEdit(user, _context) {
    // If no permissions are provided, get them from the role
    let userPermissions = user.permissions;
    if (!userPermissions || userPermissions.length === 0) {
        const { getRoleBasedPermissions } = require("./rbac");
...
function canDelete(user, _context) {
    // If no permissions are provided, get them from the role
    let userPermissions = user.permissions;
    if (!userPermissions || userPermissions.length === 0) {
        const { getRoleBasedPermissions } = require("./rbac");
...
function canApprove(user, _context) {
    // If no permissions are provided, get them from the role
    let userPermissions = user.permissions;
    if (!userPermissions || userPermissions.length === 0) {
        const { getRoleBasedPermissions } = require("./rbac");
