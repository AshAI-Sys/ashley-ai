        ...
        stops: [
          {
            coordinates: {
              lat:
                shipment.pickup_address.coordinates?.latitude.toString() || "",
              lng:
                shipment.pickup_address.coordinates?.longitude.toString() || "",
            },
          ...
          },
          {
            coordinates: {
              lat:
                shipment.delivery_address.coordinates?.latitude.toString() ||
                "",
              lng:
                shipment.delivery_address.coordinates?.longitude.toString() ||
                "",
            },
