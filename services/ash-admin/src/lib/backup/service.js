...
class BackupService {
    constructor(backupDir, maxBackups = 30) {
    ...
    async ensureBackupDir() {
        try {
            ...
            (0, error_logger_1.logError)(error, {
                category: error_logger_1.ErrorCategory.Database,
    ...
    async createBackup(options = {}) {
        const { name = `backup_${Date.now()}`, compress = true, includeData = true, includeSchema = true, } = options;
