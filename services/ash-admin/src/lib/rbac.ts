...
export type Permission =
  ...
  // Design Management
  | 'designs:read' | 'designs:create' | 'designs:update' | 'designs:delete' | 'designs:approve'
  // Production - Cutting
  | 'cutting:read' | 'cutting:create' | 'cutting:update' | 'cutting:operate'
  // Production - Printing
  | 'printing:read' | 'printing:create' | 'printing:update' | 'printing:operate'
  // Production - Sewing
  | 'sewing:read' | 'sewing:create' | 'sewing:update' | 'sewing:operate'
  // Quality Control
  | 'qc:read' | 'qc:create' | 'qc:update' | 'qc:inspect' | 'qc:approve'
  // Finishing & Packing
  | 'finishing:read' | 'finishing:create' | 'finishing:update' | 'finishing:operate'
  // Delivery
  | 'delivery:read' | 'delivery:create' | 'delivery:update' | 'delivery:dispatch'
  // Finance
  | 'finance:read' | 'finance:create' | 'finance:update' | 'finance:approve'
  // HR & Payroll
  | 'hr:read' | 'hr:create' | 'hr:update' | 'hr:delete' | 'payroll:read' | 'payroll:process'
  // Maintenance
...
export const ROLE_PERMISSIONS: Record<Role, Permission[]> = {
  ...
  manager: [
    'clients:read', 'orders:read', 'designs:read', 'designs:approve',
    'cutting:read', 'printing:read', 'sewing:read', 'qc:read', 'finishing:read', 'delivery:read',
    'analytics:read', 'reports:generate', 'hr:read'
  ],

  // Designer - Design workflow management
  designer: [
    'clients:read', 'orders:read',
    'designs:read', 'designs:create', 'designs:update'
  ],

  // Production Operators - Specific to their operations
  cutting_operator: [
    'orders:read', 'designs:read',
    'cutting:read', 'cutting:create', 'cutting:update', 'cutting:operate'
  ],
  ...
  qc_inspector: [
    'orders:read', 'designs:read',
    'cutting:read', 'printing:read', 'sewing:read',
    'qc:read', 'qc:create', 'qc:update', 'qc:inspect'
  ],
  ...
  // Warehouse Staff
  warehouse_staff: [
    'orders:read', 'delivery:read', 'delivery:create', 'delivery:update', 'delivery:dispatch'
  ],
  ...
  // HR Staff
  hr_staff: [
    'hr:read', 'hr:create', 'hr:update', 'payroll:read', 'payroll:process'
  ],
...
export function canAccessPage(userPermissions: Permission[], page: string): boolean {
...
export const ROLE_HIERARCHY: Record<Role, Role[]> = {
  admin: ['manager', 'designer', 'cutting_operator', 'printing_operator', 'sewing_operator',
          'qc_inspector', 'finishing_operator', 'warehouse_staff', 'finance_staff',
          'hr_staff', 'maintenance_tech'],
  manager: ['designer', 'cutting_operator', 'printing_operator', 'sewing_operator',
           'qc_inspector', 'finishing_operator'],
  designer: [],
  cutting_operator: [],
  printing_operator: [],
  sewing_operator: [],
