...
exports.createCSPHeader = createCSPHeader;
exports.createStrictCSPHeader = createStrictCSPHeader;
exports.getMaxSecurityHeaders = getMaxSecurityHeaders;
/**
 ...
 */
function createStrictCSPHeader(nonce) {
    const cspDirectives = [
        `default-src 'none'`,
 ...
 */
function getMaxSecurityHeaders() {
    return {
