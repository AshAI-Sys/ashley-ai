...
exports.getSpacing = exports.getColor = exports.cssVariables = exports.designSystem = void 0;
...
exports.cssVariables = {
    light: {
        '--color-primary': exports.designSystem.colors.primary,
        '--color-accent': exports.designSystem.colors.accent,
        '--color-background': exports.designSystem.colors.background,
        '--color-sidebar': exports.designSystem.colors.sidebar,
        '--color-text': exports.designSystem.colors.text,
        '--color-text-muted': exports.designSystem.colors.textMuted,
        '--color-border': exports.designSystem.colors.border,
    },
    dark: {
...
const getColor = (colorName) => {
    return exports.designSystem.colors[colorName];
};
exports.getColor = getColor;
// Utility function to get spacing value
const getSpacing = (spacingName) => {
    return exports.designSystem.spacing[spacingName];
};
exports.getSpacing = getSpacing;
exports.default = exports.designSystem;
