...
export default function QRBundleScanner({ onBundleScanned, disabled = false, className = '' }: QRBundleScannerProps) {
  const [qrInput, setQrInput] = useState('')
  const [isScanning, setIsScanning] = useState(false)
  const [isLoading, setIsLoading] = useState(false)
  const [error, setError] = useState<string | null>(null)
  const [lastScannedBundle, setLastScannedBundle] = useState<Bundle | null>(null)
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              ...
              <Button 
                ...
                disabled={disabled || isLoading || !qrInput.trim() || isScanning}
                size="default"
              >
                {isLoading ? (
