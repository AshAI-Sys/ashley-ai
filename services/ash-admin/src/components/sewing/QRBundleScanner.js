          ...
          <div className="space-y-2">
            ...
            setError(null);
              ...
              <button_1.Button onClick={handleManualScan} disabled={disabled || isLoading || !qrInput.trim() || isScanning} size="default">
                {isLoading ? (<lucide_react_1.RefreshCw className="mr-2 h-4 w-4 animate-spin"/>) : (<lucide_react_1.Search className="mr-2 h-4 w-4"/>)}
            ...
            <div className="space-y-4">
              {!isScanning ? (<button_1.Button onClick={startCameraCapture} disabled={disabled || isLoading} variant="outline" className="w-full">
                  ...
                  <div className="relative rounded-lg border-2 border-dashed bg-gray-50 p-4">
                    <video ref={videoRef} className="mx-auto w-full max-w-md rounded-lg bg-black" autoPlay muted playsInline/>
                  ...
                  <div className="flex items-center justify-center gap-2 text-blue-600">
                    <lucide_react_1.QrCode className="h-5 w-5 animate-pulse"/>
