...
function PieceRateCalculator({ runId, operatorId, operationName = "", standardMinutes = 0, baseRate = 0, editable = false, showBreakdown = true, className = "", onUpdate, }) {
    ...
    const calculatedValues = (0, react_1.useMemo)(() => {
        ...
        const qualityDeduction = parseFloat(editValues.quality_deduction) ||
    ...
    if (loading) {
        ...
        <card_1.CardContent className="py-6">
          <div className="flex items-center justify-center">
            <lucide_react_1.Calculator className="mr-2 h-6 w-6 animate-pulse"/>
    ...
    if (!pieceRateData || !calculatedValues) {
        ...
        <card_1.CardContent className="py-6">
          <div className="text-center text-muted-foreground">
            <lucide_react_1.DollarSign className="mx-auto mb-2 h-8 w-8"/>
      ...
      <card_1.Card>
        ...
        <card_1.CardContent className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
            <div className="rounded-lg border p-3 text-center">
              <div className="text-lg font-bold text-blue-600">
                {isEditing ? (<input_1.Input type="number" value={editValues.pieces_completed} onChange={e => setEditValues(prev => ({
                ...prev,
                pieces_completed: e.target.value,
            }))} className="h-8 text-center"/>) : (calculatedValues.pieces)}
              </div>
            ...
            <div className="rounded-lg border p-3 text-center">
              <div className="text-lg font-bold text-gray-600">
                {isEditing ? (<input_1.Input type="number" value={editValues.pieces_target} onChange={e => setEditValues(prev => ({
                ...prev,
                pieces_target: e.target.value,
            }))} className="h-8 text-center"/>) : (calculatedValues.target)}
              </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-medium">
                    {isEditing ? (<input_1.Input type="number" value={editValues.time_worked} onChange={e => setEditValues(prev => ({
                ...prev,
                time_worked: e.target.value,
            }))} className="h-6 w-20 text-right"/>) : (`${calculatedValues.timeWorked}m`)}
                  </span>
                </div>
                <div className="flex justify-between text-sm">
            ...
            {/* Quality Adjustment */}
            {(isEditing || calculatedValues.qualityPenalty > 0) && (<div className="rounded-lg border bg-red-50 p-3">
                <label_1.Label className="text-sm font-medium text-red-900">
                  Quality Deduction
                </label_1.Label>
                <div className="mt-1 flex items-center gap-2">
                  <span className="text-sm text-red-700">₱</span>
                  {isEditing ? (<input_1.Input type="number" step="0.01" value={editValues.quality_deduction} onChange={e => setEditValues(prev => ({
                    ...prev,
                    quality_deduction: e.target.value,
                }))} className="h-8 w-24"/>) : (<span className="font-medium text-red-900">
                      {calculatedValues.qualityPenalty.toFixed(2)}
                    </span>)}
          ...
          <div className="space-y-3">
            {calculatedValues.efficiency >= 110 && (<div className="flex items-start gap-2 rounded-lg bg-green-50 p-3">
                <lucide_react_1.Award className="mt-0.5 h-5 w-5 text-green-600"/>
                <div>
            ...
            calculatedValues.efficiency < 110 && (<div className="flex items-start gap-2 rounded-lg bg-blue-50 p-3">
                  <lucide_react_1.CheckCircle className="mt-0.5 h-5 w-5 text-blue-600"/>
                  <div>
            ...
            {calculatedValues.efficiency < 90 && (<div className="flex items-start gap-2 rounded-lg bg-yellow-50 p-3">
                <lucide_react_1.AlertTriangle className="mt-0.5 h-5 w-5 text-yellow-600"/>
                <div>
