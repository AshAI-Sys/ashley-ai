...
export default function PieceRateCalculator({
  ...
  const [pieceRateData, setPieceRateData] = useState<PieceRateData | null>(null)
  ...
  const getEfficiencyBadgeColor = (efficiency: number) => {
    if (efficiency >= 110) return 'bg-green-100 text-green-800 border-green-200'
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <Badge className={getEfficiencyBadgeColor(calculatedValues.efficiency)}>
        ...
        <CardContent className="space-y-6">
              ...
              <div className="text-lg font-bold text-blue-600">
                {isEditing ? (
                  <Input
                    ...
                    onChange={(e) => setEditValues(prev => ({...prev, pieces_completed: e.target.value}))}
              ...
              <div className="text-lg font-bold text-gray-600">
                {isEditing ? (
                  <Input
                    ...
                    onChange={(e) => setEditValues(prev => ({...prev, pieces_target: e.target.value}))}
                    className="text-center h-8"
                  />
                ) : (
          ...
          <div className="space-y-4">
                  ...
                  <span className="font-medium">
                    {isEditing ? (
                      <Input
                        ...
                        onChange={(e) => setEditValues(prev => ({...prev, time_worked: e.target.value}))}
            ...
            {(isEditing || calculatedValues.qualityPenalty > 0) && (
              <div className="p-3 border rounded-lg bg-red-50">
                <Label className="text-sm font-medium text-red-900">Quality Deduction</Label>
                <div className="flex items-center gap-2 mt-1">
                  ...
                  {isEditing ? (
                    <Input
                      ...
                      onChange={(e) => setEditValues(prev => ({...prev, quality_deduction: e.target.value}))}
                      className="w-24 h-8"
                    />
                  ) : (
          ...
          <div className="space-y-3">
            ...
            {calculatedValues.efficiency >= 100 && calculatedValues.efficiency < 110 && (
