        ...
        <div className="relative">
          ...
          <div className="space-y-6">
            ...
            return (<div key={event.id} className="relative flex items-start gap-4">
                    {/* Icon */}
                    <div className={`relative z-10 flex h-12 w-12 items-center justify-center rounded-full ${config.bgColor} ${config.color} `}>
                    ...
                    <div className="min-w-0 flex-1 pb-6">
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          ...
                          {event.actor && (<div className="mt-1 flex items-center gap-1 text-sm text-gray-600">
                          ...
                          {event.details && (<p className="mt-2 rounded bg-gray-50 p-3 text-sm text-gray-600">
                              {event.details}
                            </p>)}
                        </div>
