      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              {monitoringData && (
                <Badge className={`${getGradeColor(monitoringData.performance_score.grade)} font-bold`}>
                ...
                <>
                  ...
                  <Card>
                    <CardContent className="pt-6">
                      ...
                      <Progress value={optimizationData.confidence_score * 100} />
                    </CardContent>
                  </Card>
                ...
                <>
                  ...
                  <Card>
                    ...
                    <CardContent>
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        {Object.entries(monitoringData.performance_score.component_scores).map(([key, score]) => (
                          <div key={key}>
                  ...
                  {monitoringData.insights.risk_factors.length > 0 && (
                    <Card>
                      ...
                      <CardContent>
                        <div className="space-y-3">
                          {monitoringData.insights.risk_factors.map((risk, index) => (
                            <Alert key={index} className={risk.level === 'HIGH' ? 'border-red-200 bg-red-50' : 'border-yellow-200 bg-yellow-50'}>
                              <div className="flex items-start justify-between">
                                <div className="flex-1">
                                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <CardContent>
                      <div className="space-y-4">
                        <div>
                          ...
                          <Progress value={monitoringData.insights.efficiency_score.score * 100} />
                        </div>
                        
                        {Object.entries(monitoringData.insights.efficiency_score.factors).map(([key, value]) => (
                          <div key={key}>
                            <div className="flex justify-between mb-1">
                  ...
                  <Card>
                    ...
                    <CardContent>
                      ...
                      <div className="mt-4">
                        ...
                        <Progress value={monitoringData.insights.time_prediction.confidence * 100} />
                      </div>
                    </CardContent>
                  </Card>
                    ...
                    <CardContent>
                      <div className="space-y-3">
                        ...
                        <div className="flex justify-between">
                          ...
                          <span className={`font-medium ${
                            monitoringData.insights.cost_tracking.profit_margin > 0.2 
                              ? 'text-green-600' 
