      ...
      <card_1.Card>
        ...
        <card_1.CardContent>
          <div className="space-y-3">
            {Object.entries(aiData.method_performance).map(([method, data]) => (<div key={method} className="flex items-center justify-between p-3 border rounded">
                <div>
                ...
                <div className="text-right">
                  ...
                  <progress_1.Progress value={data.score * 100} className="w-20 mt-1"/>
                </div>
              </div>))}
          </div>
        </card_1.CardContent>
      ...
      <card_1.Card>
        ...
        <card_1.CardContent>
          <div className="space-y-3">
            ...
            {aiData.recommendations.length === 0 && (<div className="text-center py-4 text-muted-foreground">
