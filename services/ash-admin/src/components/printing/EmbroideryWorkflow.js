...
function EmbroideryWorkflow({ runId, onUpdate, readOnly = false, }) {
    ...
    const calculateEfficiency = () => {
        if (data.ashley_recommendations.runtime_prediction_minutes === 0)
            return 0;
        return Math.round((data.ashley_recommendations.runtime_prediction_minutes /
        ...
        <card_1.CardHeader>
          <div className="flex items-center gap-2">
            <div className="rounded-full bg-green-100 p-2">
              <lucide_react_1.Shirt className="h-5 w-5 text-green-600"/>
            </div>
            <div>
          ...
          <card_1.CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <input_1.Input value={data.design_setup.dst_file_path} onChange={e => updateData("design_setup", {
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="space-y-2">
                ...
                <input_1.Input type="number" min="0" value={data.design_setup.stitch_count} onChange={e => updateData("design_setup", {
            ...
            <div className="space-y-4">
              ...
              {data.design_setup.thread_colors.map((color, index) => (<div key={index} className="grid grid-cols-6 gap-4 rounded-lg border p-4">
                  <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-2">
                      <input_1.Input type="color" value={color.color_code} onChange={e => updateThreadColor(index, "color_code", e.target.value)} className="h-8 w-12 border p-0" disabled={readOnly}/>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <select_1.Select value={data.machine_setup.machine_id} onValueChange={value => updateData("machine_setup", { machine_id: value })} disabled={readOnly}>
                  ...
                  <select_1.SelectContent>
                    <select_1.SelectItem value="EMB001">
                      Tajima 16-Head (EMB001)
                    </select_1.SelectItem>
                    <select_1.SelectItem value="EMB002">
                      Brother 10-Head (EMB002)
                    </select_1.SelectItem>
                    <select_1.SelectItem value="EMB003">
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="space-y-2">
                ...
                <select_1.Select value={data.machine_setup.needle_type} onValueChange={value => updateData("machine_setup", { needle_type: value })} disabled={readOnly}>
                  ...
                  <select_1.SelectContent>
                    <select_1.SelectItem value="Universal 75/11">
                      Universal 75/11
                    </select_1.SelectItem>
                    <select_1.SelectItem value="Universal 90/14">
                      Universal 90/14
                    </select_1.SelectItem>
                    <select_1.SelectItem value="Ballpoint 75/11">
                      Ballpoint 75/11
                    </select_1.SelectItem>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-4">
                  <input_1.Input type="range" min="1" max="5" step="0.1" value={data.machine_setup.thread_tension} onChange={e => updateData("machine_setup", {
              ...
              <div className="space-y-2">
                ...
                <input_1.Input type="number" min="400" max="1200" step="50" value={data.machine_setup.machine_speed_spm} onChange={e => updateData("machine_setup", {
          ...
          <card_1.CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
              <div className="space-y-2">
                ...
                <input_1.Input type="number" min="0" value={data.production.pieces_completed} onChange={e => updateData("production", {
                pieces_completed: parseInt(e.target.value) || 0,
            })} readOnly={readOnly}/>
              </div>
              <div className="space-y-2">
                <label_1.Label>Thread Breaks</label_1.Label>
                <input_1.Input type="number" min="0" value={data.production.thread_breaks} onChange={e => updateData("production", {
                thread_breaks: parseInt(e.target.value) || 0,
            })} readOnly={readOnly}/>
              </div>
              <div className="space-y-2">
                <label_1.Label>Needle Breaks</label_1.Label>
                <input_1.Input type="number" min="0" value={data.production.needle_breaks} onChange={e => updateData("production", {
                needle_breaks: parseInt(e.target.value) || 0,
            })} readOnly={readOnly}/>
              </div>
              <div className="space-y-2">
                <label_1.Label>Runtime (minutes)</label_1.Label>
                <input_1.Input type="number" min="0" value={data.production.actual_runtime_minutes} onChange={e => updateData("production", {
            ...
            {data.production.actual_runtime_minutes > 0 && (<div className="rounded-lg bg-blue-50 p-4">
            ...
            <div className="space-y-4">
              ...
              {data.production.machine_stops.map((stop, index) => (<div key={index} className="grid grid-cols-4 gap-4 rounded-lg border p-4">
                  <div className="space-y-2">
                    ...
                    <select_1.Select value={stop.reason} onValueChange={value => updateMachineStop(index, "reason", value)} disabled={readOnly}>
                      ...
                      <select_1.SelectContent>
                        <select_1.SelectItem value="THREAD_BREAK">
                          Thread Break
                        </select_1.SelectItem>
                        <select_1.SelectItem value="NEEDLE_BREAK">
                          Needle Break
                        </select_1.SelectItem>
                        <select_1.SelectItem value="THREAD_CHANGE">
                          Thread Change
                        </select_1.SelectItem>
                        <select_1.SelectItem value="REGISTRATION_CHECK">
                          Registration Check
                        </select_1.SelectItem>
                        <select_1.SelectItem value="MACHINE_JAM">Machine Jam</select_1.SelectItem>
                        <select_1.SelectItem value="QUALITY_ISSUE">
                          Quality Issue
                        </select_1.SelectItem>
              ...
              {data.production.machine_stops.length === 0 && (<div className="py-8 text-center text-muted-foreground">
      ...
      {activeStep === "quality" && (<card_1.Card>
          ...
          <card_1.CardContent className="space-y-4">
            <div className="space-y-3">
              <div className="flex items-center space-x-2">
                <input type="checkbox" id="stitchQuality" checked={data.quality_control.stitch_quality_check} onChange={e => updateData("quality_control", {
              ...
              <div className="flex items-center space-x-2">
                <input type="checkbox" id="threadTension" checked={data.quality_control.thread_tension_ok} onChange={e => updateData("quality_control", {
              ...
              <div className="flex items-center space-x-2">
                <input type="checkbox" id="registration" checked={data.quality_control.registration_accuracy} onChange={e => updateData("quality_control", {
                registration_accuracy: e.target.checked,
            })} disabled={readOnly}/>
                <label_1.Label htmlFor="registration">
                  Registration accuracy approved
                </label_1.Label>
              </div>

              <div className="flex items-center space-x-2">
                <input type="checkbox" id="puckering" checked={data.quality_control.fabric_puckering_check} onChange={e => updateData("quality_control", {
              ...
              <div className="flex items-center space-x-2">
                <input type="checkbox" id="colorMatch" checked={data.quality_control.color_match_approved} onChange={e => updateData("quality_control", {
