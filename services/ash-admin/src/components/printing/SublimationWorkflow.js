    ...
    return (<div className="space-y-6">
        ...
        <card_1.CardHeader>
          <div className="flex items-center gap-2">
            <div className="p-2 bg-yellow-100 rounded-full">
              <lucide_react_1.Zap className="w-5 h-5 text-yellow-600"/>
            </div>
            <div>
              <card_1.CardTitle className="text-lg">Ashley AI Sublimation Optimization</card_1.CardTitle>
              <card_1.CardDescription>Smart recommendations for optimal sublimation results</card_1.CardDescription>
            </div>
          </div>
        </card_1.CardHeader>
        <card_1.CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="text-center p-3 bg-blue-50 rounded-lg">
              <div className="text-2xl font-bold text-blue-600">{data.ashley_recommendations.color_accuracy_prediction}%</div>
              <p className="text-sm text-muted-foreground">Color Accuracy</p>
            </div>
            <div className="text-center p-3 bg-purple-50 rounded-lg">
              <div className="text-2xl font-bold text-purple-600">{data.ashley_recommendations.optimal_temperature}°C</div>
              <p className="text-sm text-muted-foreground">Optimal Temp</p>
            </div>
            <div className="text-center p-3 bg-orange-50 rounded-lg">
              <div className="text-2xl font-bold text-orange-600">{data.ashley_recommendations.transfer_efficiency}%</div>
              <p className="text-sm text-muted-foreground">Transfer Efficiency</p>
            </div>
          </div>
        </card_1.CardContent>
      </card_1.Card>
      ...
      {activeStep === 'setup' && (<card_1.Card>
          <card_1.CardHeader>
            ...
            <card_1.CardDescription>Configure design file and print settings</card_1.CardDescription>
          </card_1.CardHeader>
          <card_1.CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <select_1.Select value={data.digital_setup.print_resolution.toString()} onValueChange={(value) => updateData('digital_setup', { print_resolution: parseInt(value) })} disabled={readOnly}>
                  ...
                  <select_1.SelectContent>
                    ...
                    <select_1.SelectItem value="2880">2880 DPI (High Quality)</select_1.SelectItem>
                  </select_1.SelectContent>
                </select_1.Select>
              </div>
            </div>
              ...
              <div className="space-y-2">
                ...
                <select_1.Select value={data.digital_setup.color_profile} onValueChange={(value) => updateData('digital_setup', { color_profile: value })} disabled={readOnly}>
                  ...
                  <select_1.SelectContent>
                    ...
                    <select_1.SelectItem value="Epson_Standard">Epson Standard</select_1.SelectItem>
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-4">
                <input_1.Input type="range" min="80" max="120" value={data.digital_setup.ink_density} onChange={(e) => updateData('digital_setup', { ink_density: parseInt(e.target.value) })} className="flex-1" disabled={readOnly}/>
                <span className="text-sm font-medium w-12">{data.digital_setup.ink_density}%</span>
              </div>
            </div>
          ...
          <card_1.CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <input_1.Input type="number" step="0.1" min="0" value={data.printing.paper_consumed_m2} onChange={(e) => updateData('printing', { paper_consumed_m2: parseFloat(e.target.value) || 0 })} readOnly={readOnly}/>
              </div>
              <div className="space-y-2">
                <label_1.Label>Color Accuracy (%)</label_1.Label>
                <input_1.Input type="number" min="0" max="100" value={data.printing.color_accuracy} onChange={(e) => updateData('printing', { color_accuracy: parseInt(e.target.value) || 0 })} readOnly={readOnly}/>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                {data.printing.ink_usage_ml.map((ink, index) => (<div key={index} className="flex items-center gap-2">
                    <div className={`w-4 h-4 rounded ${ink.color === 'Cyan' ? 'bg-cyan-500' :
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center space-x-2">
                <input type="checkbox" id="registrationMarks" checked={data.printing.registration_marks} onChange={(e) => updateData('printing', { registration_marks: e.target.checked })} disabled={readOnly}/>
                <label_1.Label htmlFor="registrationMarks">Registration marks visible</label_1.Label>
              </div>
            </div>

            <div className="p-4 bg-blue-50 rounded-lg">
              <h4 className="font-medium mb-2">Print Quality Checklist:</h4>
      ...
      {activeStep === 'press' && (<card_1.Card>
          <card_1.CardHeader>
            ...
            <card_1.CardDescription>Apply heat and pressure for sublimation transfer</card_1.CardDescription>
          </card_1.CardHeader>
          <card_1.CardContent className="space-y-4">
            <div className="grid grid-cols-3 gap-4">
              <div className="space-y-2">
                <label_1.Label>Temperature (°C)</label_1.Label>
                <input_1.Input type="number" min="180" max="220" value={data.heat_press.temperature_c} onChange={(e) => updateData('heat_press', { temperature_c: parseInt(e.target.value) })} readOnly={readOnly}/>
                <p className="text-xs text-muted-foreground">
                  Recommended: {data.ashley_recommendations.optimal_temperature}°C
                </p>
              </div>
              <div className="space-y-2">
                <label_1.Label>Time (seconds)</label_1.Label>
                <input_1.Input type="number" min="30" max="120" value={data.heat_press.time_seconds} onChange={(e) => updateData('heat_press', { time_seconds: parseInt(e.target.value) })} readOnly={readOnly}/>
              </div>
              <div className="space-y-2">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <input_1.Input type="number" min="1" max="3" value={data.heat_press.cycles} onChange={(e) => updateData('heat_press', { cycles: parseInt(e.target.value) })} readOnly={readOnly}/>
                <p className="text-xs text-muted-foreground">Multiple cycles for thick fabrics</p>
              </div>
              <div className="space-y-2">
                <label_1.Label>Cooling Time (seconds)</label_1.Label>
                <input_1.Input type="number" min="15" max="60" value={data.heat_press.cooling_time} onChange={(e) => updateData('heat_press', { cooling_time: parseInt(e.target.value) })} readOnly={readOnly}/>
              </div>
            </div>

            <div className="flex items-center space-x-2">
              <input type="checkbox" id="transferQuality" checked={data.heat_press.transfer_quality} onChange={(e) => updateData('heat_press', { transfer_quality: e.target.checked })} disabled={readOnly}/>
      ...
      {activeStep === 'quality' && (<card_1.Card>
          <card_1.CardHeader>
            ...
            <card_1.CardDescription>Final quality assessment and approval</card_1.CardDescription>
          </card_1.CardHeader>
          <card_1.CardContent className="space-y-4">
            <div className="space-y-3">
              <div className="flex items-center space-x-2">
                <input type="checkbox" id="colorFastness" checked={data.quality_control.color_fastness_test} onChange={(e) => updateData('quality_control', { color_fastness_test: e.target.checked })} disabled={readOnly}/>
                <label_1.Label htmlFor="colorFastness">Color fastness test completed</label_1.Label>
              </div>

              <div className="flex items-center space-x-2">
                <input type="checkbox" id="washDurability" checked={data.quality_control.wash_durability_test} onChange={(e) => updateData('quality_control', { wash_durability_test: e.target.checked })} disabled={readOnly}/>
                <label_1.Label htmlFor="washDurability">Wash durability test completed</label_1.Label>
              </div>

              <div className="flex items-center space-x-2">
                <input type="checkbox" id="handFeel" checked={data.quality_control.hand_feel_assessment} onChange={(e) => updateData('quality_control', { hand_feel_assessment: e.target.checked })} disabled={readOnly}/>
