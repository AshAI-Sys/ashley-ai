    ...
    const getStepStatus = (step) => {
        switch (step) {
            ...
            case "powder_application":
                return data.powder_application.coverage_uniformity
                    ? "complete"
                    : "pending";
            case "curing":
    ...
    return (<div className="space-y-6">
        ...
        <card_1.CardHeader>
          <div className="flex items-center gap-2">
            <div className="rounded-full bg-blue-100 p-2">
              <lucide_react_1.Package2 className="h-5 w-5 text-blue-600"/>
            </div>
            <div>
              <card_1.CardTitle className="text-lg">
                Ashley AI DTF Optimization
              </card_1.CardTitle>
              <card_1.CardDescription>
                Smart recommendations for Direct-to-Film printing
              </card_1.CardDescription>
            </div>
          </div>
        </card_1.CardHeader>
          ...
          <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
            ...
            <div className="rounded-lg bg-blue-50 p-3 text-center">
              <div className="text-2xl font-bold text-blue-600">
                {data.ashley_recommendations.transfer_success_rate}%
              </div>
            ...
            <div className="rounded-lg bg-orange-50 p-3 text-center">
              <div className="text-2xl font-bold text-orange-600">
                {data.ashley_recommendations.powder_efficiency}%
              </div>
      ...
      {activeStep === "setup" && (<card_1.Card>
          <card_1.CardHeader>
            <card_1.CardTitle className="flex items-center gap-2">
              <lucide_react_1.Package2 className="h-5 w-5"/>
              DTF Film Setup
            </card_1.CardTitle>
            <card_1.CardDescription>
              Configure film type and print settings
            </card_1.CardDescription>
          </card_1.CardHeader>
          <card_1.CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <select_1.Select value={data.film_setup.film_type} onValueChange={value => updateData("film_setup", { film_type: value })} disabled={readOnly}>
                  ...
                  <select_1.SelectContent>
                    <select_1.SelectItem value="PET_Film_75mic">
                      PET Film 75μm
                    </select_1.SelectItem>
                    <select_1.SelectItem value="PET_Film_100mic">
                      PET Film 100μm
                    </select_1.SelectItem>
                    <select_1.SelectItem value="Cold_Peel_Film">
                      Cold Peel Film
                    </select_1.SelectItem>
                  </select_1.SelectContent>
                </select_1.Select>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <select_1.Select value={data.film_setup.print_resolution.toString()} onValueChange={value => updateData("film_setup", {
      ...
      {activeStep === "print" && (<card_1.Card>
          <card_1.CardHeader>
            ...
            <card_1.CardDescription>
              Print design onto DTF film with white ink underbase
            </card_1.CardDescription>
          </card_1.CardHeader>
          <card_1.CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <input_1.Input type="number" step="0.1" min="0" value={data.printing.film_consumed_m2} onChange={e => updateData("printing", {
                film_consumed_m2: parseFloat(e.target.value) || 0,
            })} readOnly={readOnly}/>
              </div>
              <div className="space-y-2">
                <label_1.Label>Color Density (%)</label_1.Label>
                <input_1.Input type="number" min="0" max="100" value={data.printing.color_density} onChange={e => updateData("printing", {
                color_density: parseInt(e.target.value) || 0,
            })} readOnly={readOnly}/>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                {data.printing.ink_usage_ml.map((ink, index) => (<div key={index} className="flex items-center gap-2">
                    <div className={`h-4 w-4 rounded border ${ink.color === "White"
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center space-x-2">
                <input type="checkbox" id="edgeDefinition" checked={data.printing.edge_definition} onChange={e => updateData("printing", {
                edge_definition: e.target.checked,
            })} disabled={readOnly}/>
          ...
          <card_1.CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <select_1.Select value={data.powder_application.powder_type} onValueChange={value => updateData("powder_application", { powder_type: value })} disabled={readOnly}>
                  ...
                  <select_1.SelectContent>
                    ...
                    <select_1.SelectItem value="Low_Temp_Powder">
                      Low Temp Powder
                    </select_1.SelectItem>
              ...
              <div className="space-y-2">
                ...
                <select_1.Select value={data.powder_application.application_method} onValueChange={value => updateData("powder_application", {
                application_method: value,
                  ...
                  <select_1.SelectContent>
                    ...
                    <select_1.SelectItem value="AUTOMATIC">
            ...
            <div className="space-y-2">
              ...
              <input_1.Input type="number" step="1" min="0" value={data.powder_application.powder_consumed_g} onChange={e => updateData("powder_application", {
                powder_consumed_g: parseFloat(e.target.value) || 0,
            })} readOnly={readOnly}/>
              <p className="text-xs text-muted-foreground">
                Estimated: {data.ashley_recommendations.powder_efficiency}%
                efficiency
              </p>
            </div>
            ...
            <div className="space-y-2">
              <div className="flex items-center space-x-2">
                <input type="checkbox" id="uniformCoverage" checked={data.powder_application.coverage_uniformity} onChange={e => updateData("powder_application", {
                coverage_uniformity: e.target.checked,
            })} disabled={readOnly}/>
                <label_1.Label htmlFor="uniformCoverage">Uniform powder coverage</label_1.Label>
              </div>
              <div className="flex items-center space-x-2">
                <input type="checkbox" id="recycledPowder" checked={data.powder_application.excess_powder_recycled} onChange={e => updateData("powder_application", {
                excess_powder_recycled: e.target.checked,
            })} disabled={readOnly}/>
      ...
      {activeStep === "cure" && (<card_1.Card>
          <card_1.CardHeader>
            ...
            <card_1.CardDescription>
              Cure powder to create adhesive layer
            </card_1.CardDescription>
          </card_1.CardHeader>
          <card_1.CardContent className="space-y-4">
            <div className="grid grid-cols-3 gap-4">
              <div className="space-y-2">
                ...
                <input_1.Input type="number" min="140" max="180" value={data.curing.temperature_c} onChange={e => updateData("curing", {
              ...
              <div className="space-y-2">
                ...
                <input_1.Input type="number" min="30" max="120" value={data.curing.time_seconds} onChange={e => updateData("curing", {
            ...
            <div className="space-y-2">
              <div className="flex items-center space-x-2">
                <input type="checkbox" id="adhesionTest" checked={data.curing.powder_adhesion_test} onChange={e => updateData("curing", {
                powder_adhesion_test: e.target.checked,
            })} disabled={readOnly}/>
                <label_1.Label htmlFor="adhesionTest">
                  Powder adhesion test passed
                </label_1.Label>
              </div>
              <div className="flex items-center space-x-2">
                <input type="checkbox" id="flexibilityTest" checked={data.curing.film_flexibility_test} onChange={e => updateData("curing", {
                film_flexibility_test: e.target.checked,
            })} disabled={readOnly}/>
                <label_1.Label htmlFor="flexibilityTest">
                  Film flexibility maintained
                </label_1.Label>
              </div>
            </div>
      ...
      {activeStep === "transfer" && (<card_1.Card>
          <card_1.CardHeader>
            <card_1.CardTitle className="flex items-center gap-2">
              <lucide_react_1.Timer className="h-5 w-5"/>
              Heat Press Transfer
            </card_1.CardTitle>
          ...
          <card_1.CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <input_1.Input type="number" min="140" max="180" value={data.transfer.press_temperature_c} onChange={e => updateData("transfer", {
                press_temperature_c: parseInt(e.target.value),
            })} readOnly={readOnly}/>
              </div>
              <div className="space-y-2">
                <label_1.Label>Press Time (seconds)</label_1.Label>
                <input_1.Input type="number" min="10" max="30" value={data.transfer.press_time_seconds} onChange={e => updateData("transfer", {
                press_time_seconds: parseInt(e.target.value),
            })} readOnly={readOnly}/>
              </div>
            </div>
      ...
      {activeStep === "quality" && (<card_1.Card>
          ...
          <card_1.CardContent className="space-y-4">
            <div className="space-y-3">
              <div className="flex items-center space-x-2">
                <input type="checkbox" id="adhesionTest" checked={data.quality_control.adhesion_test} onChange={e => updateData("quality_control", {
                adhesion_test: e.target.checked,
            })} disabled={readOnly}/>
                <label_1.Label htmlFor="adhesionTest">Adhesion test passed</label_1.Label>
              </div>

              <div className="flex items-center space-x-2">
                <input type="checkbox" id="stretchTest" checked={data.quality_control.stretch_test} onChange={e => updateData("quality_control", {
                stretch_test: e.target.checked,
            })} disabled={readOnly}/>
                <label_1.Label htmlFor="stretchTest">Stretch test passed</label_1.Label>
              </div>

              <div className="flex items-center space-x-2">
                <input type="checkbox" id="washDurability" checked={data.quality_control.wash_durability} onChange={e => updateData("quality_control", {
                wash_durability: e.target.checked,
            })} disabled={readOnly}/>
                <label_1.Label htmlFor="washDurability">
                  Wash durability test passed
                </label_1.Label>
              </div>
