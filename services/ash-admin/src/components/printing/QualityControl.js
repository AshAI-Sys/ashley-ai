        ...
        <card_1.CardHeader>
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <card_1.CardDescription>Real-time quality tracking for {method} run</card_1.CardDescription>
            </div>
          </div>
        </card_1.CardHeader>
        <card_1.CardContent>
          ...
          <card_1.Card>
                      ...
                      <div className="space-y-4">
                        <div className="grid grid-cols-2 gap-4">
                          <div className="space-y-2">
                            ...
                            <select_1.Select value={newDefect.reason_code} onValueChange={(value) => setNewDefect({ ...newDefect, reason_code: value })}>
                          ...
                          <div className="space-y-2">
                            ...
                            <input_1.Input type="number" min="1" value={newDefect.quantity} onChange={(e) => setNewDefect({ ...newDefect, quantity: parseInt(e.target.value) || 1 })}/>
                          </div>
                        </div>

                        <div className="space-y-2">
                          <label_1.Label>Cost Attribution</label_1.Label>
                          <select_1.Select value={newDefect.cost_attribution} onValueChange={(value) => setNewDefect({ ...newDefect, cost_attribution: value })}>
                            <select_1.SelectTrigger>
                        ...
                        <div className="space-y-2">
                          ...
                          <input_1.Input value={newDefect.location} onChange={(e) => setNewDefect({ ...newDefect, location: e.target.value })} placeholder="e.g., Front chest, Left sleeve"/>
                        </div>

                        <div className="space-y-2">
                          <label_1.Label>Description</label_1.Label>
                          <textarea_1.Textarea value={newDefect.description} onChange={(e) => setNewDefect({ ...newDefect, description: e.target.value })} placeholder="Detailed description of the defect..." rows={3}/>
                        </div>
            ...
            <card_1.CardContent>
              {defects.length > 0 ? (<div className="space-y-3">
                ...
                return (<div key={defect.id} className="flex items-start justify-between p-4 border rounded-lg">
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-2">
                            <badge_1.Badge className={severityColors[defectInfo?.severity || 'MINOR']}>
                          ...
                          {defect.location && (<p className="text-sm text-muted-foreground mb-1">
                              Location: {defect.location}
                            </p>)}
                          
                          {defect.description && (<p className="text-sm text-muted-foreground mb-2">
                              {defect.description}
                            </p>)}
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            {!readOnly && (<button_1.Button size="sm" variant="outline" onClick={() => capturePhoto(defect.id)}>
                                <lucide_react_1.Camera className="w-3 h-3 mr-1"/>
                                Photo
                              </button_1.Button>)}
                          </div>
                        </div>
        ...
        <tabs_1.TabsContent value="inspection" className="space-y-4">
          <card_1.Card>
            ...
            <card_1.CardContent className="space-y-4">
              ...
              {finalApproval && qualityMetrics.quality_rate >= 95 && (<div className="p-4 bg-green-50 rounded-lg border border-green-200">
              ...
              {finalApproval && qualityMetrics.quality_rate < 95 && (<div className="p-4 bg-orange-50 rounded-lg border border-orange-200">
            ...
            <card_1.Card>
              ...
              <card_1.CardContent>
                {Object.entries(defectsBySeverity).length > 0 ? (<div className="space-y-3">
                  ...
                  </div>) : (<p className="text-muted-foreground text-center py-4">No defects to analyze</p>)}
              </card_1.CardContent>
            </card_1.Card>
...
function MethodInspectionChecklist({ method }) {
    ...
    return (<div className="space-y-2">
      <label_1.Label className="text-base font-medium">Inspection Checklist - {method}</label_1.Label>
      <div className="space-y-2">
