...
import { AlertCircle, Package2, Plus, Search, Trash2, Save, CheckCircle } from 'lucide-react'
...
export default function MaterialConsumption({ runId, method, onUpdate, readOnly = false }: MaterialConsumptionProps) {
  const [materials, setMaterials] = useState<Material[]>([])
  const [consumedMaterials, setConsumedMaterials] = useState<MaterialConsumption[]>([])
        ...
        <CardHeader>
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <CardDescription>Track materials used for {method} printing</CardDescription>
            </div>
          </div>
        </CardHeader>
        <CardContent>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-2">
                  ...
                  <DialogContent className="max-w-2xl">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <Select value={newConsumption.material_id} onValueChange={(value) => setNewConsumption({...newConsumption, material_id: value})}>
                          <SelectTrigger>
                      ...
                      {/* Cost Preview */}
                      {newConsumption.material_id && newConsumption.quantity && (
                      ...
                      <div className="flex justify-end gap-2">
                        ...
                        <Button onClick={addMaterial} disabled={!newConsumption.material_id || !newConsumption.quantity}>
                          Add Material
                        </Button>
                      </div>
                    </div>
              ...
              {consumedMaterials.length > 0 && !readOnly && (
                <Button size="sm" variant="outline" onClick={saveMaterialConsumption} disabled={loading}>
          ...
          {consumedMaterials.length > 0 ? (
            <div className="space-y-3">
              {consumedMaterials.map((material, index) => (
                <div key={material.material_id} className="flex items-center justify-between p-4 border rounded-lg">
            ...
            <div className="text-center py-8">
              <Package2 className="w-8 h-8 mx-auto mb-2 text-muted-foreground" />
...
function MethodMaterialGuidelines({ method }: { method: string }) {
  ...
  const methodGuidelines = guidelines[method as keyof typeof guidelines] || ['• No specific guidelines available']
