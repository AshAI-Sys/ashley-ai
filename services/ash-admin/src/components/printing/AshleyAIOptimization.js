          ...
          <card_1.CardTitle className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <button_1.Button variant="outline" size="sm" onClick={() => setAutoRefresh(!autoRefresh)} className={autoRefresh ? "bg-green-50 text-green-700" : ""}>
                <lucide_react_1.Activity className="mr-1 h-4 w-4"/>
                        ...
                        {optimizationData.recommendations.map((rec, index) => (<alert_1.Alert key={index}>
                            <div className="flex items-start justify-between">
                              <div className="flex-1">
                                ...
                                {rec.action && (<div className="mt-1 text-xs text-muted-foreground">
                                    Action: {rec.action}
                                  </div>)}
                              </div>
                            </div>
            ...
            <tabs_1.TabsContent value="monitoring" className="space-y-4">
              {monitoringData && (<>
                    ...
                    <card_1.CardContent>
                      <div className="mb-4 text-center">
                        ...
                        <div className="text-sm text-muted-foreground">
                          {Math.round(monitoringData.performance_score.overall_score * 100)}
                          % Overall
                        </div>
                      </div>
                  ...
                  {monitoringData.insights.risk_factors.length > 0 && (<card_1.Card>
                      ...
                      <card_1.CardContent>
                        <div className="space-y-3">
                          {monitoringData.insights.risk_factors.map((risk, index) => (<alert_1.Alert key={index} className={risk.level === "HIGH"
                        ? "border-red-200 bg-red-50"
                        : "border-yellow-200 bg-yellow-50"}>
                                <div className="flex items-start justify-between">
                                  <div className="flex-1">
                                    <div className="mb-1 flex items-center gap-2">
                                      <badge_1.Badge variant={risk.level === "HIGH"
                        ? "destructive"
                        : "secondary"}>
                                        {risk.level}
                                      </badge_1.Badge>
                  ...
                  <card_1.Card>
                    ...
                    <card_1.CardContent>
                      <div className="space-y-3">
                        ...
                        {monitoringData.recommendations.length === 0 && (<div className="py-4 text-center text-muted-foreground">
                      ...
                      <div className="space-y-4">
                        <div>
                          <div className="mb-2 flex justify-between">
                            ...
                            <span className="text-sm font-bold">
                              {Math.round(monitoringData.insights.efficiency_score.score *
                100)}
                              %
                            </span>
                          </div>
                          <progress_1.Progress value={monitoringData.insights.efficiency_score.score *
                100}/>
                        </div>
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          <div className="text-2xl font-bold text-green-600">
                            {Math.round(monitoringData.insights.material_utilization
                ...
                .waste_percentage}
                        ...
                        <div>
                          <div className="text-2xl font-bold text-blue-600">
                            {formatCurrency(monitoringData.insights.material_utilization
                .total_cost)}
                          </div>
                          <div className="text-xs text-muted-foreground">
                            Material Cost
              ...
              {monitoringData && (<>
                  ...
                  <card_1.Card>
                    ...
                    <card_1.CardContent>
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          <div className="text-lg font-bold">
                            {formatTime(monitoringData.insights.time_prediction
                .remaining_minutes)}
                          </div>
                          <div className="text-xs text-muted-foreground">
                            Remaining Time
                      ...
                      <div className="mt-4">
                        <div className="mb-1 flex justify-between">
                          ...
                          <span className="text-sm font-medium">
                            {Math.round(monitoringData.insights.time_prediction
                .confidence * 100)}
                            %
                          </span>
                        </div>
                        <progress_1.Progress value={monitoringData.insights.time_prediction.confidence *
                100}/>
                      </div>
                    </card_1.CardContent>
                  </card_1.Card>
                      ...
                      <div className="space-y-3">
                        <div className="flex justify-between">
                          ...
                          <span className="font-medium">
                            {formatCurrency(monitoringData.insights.cost_tracking
                .material_cost)}
                          </span>
                        </div>
                ...
                .overhead_cost)}
                        ...
                        <div className="flex justify-between font-bold">
                          ...
                          <span>
                            {formatCurrency(monitoringData.insights.cost_tracking.total_cost)}
                          </span>
                        </div>
                ...
                .estimated_revenue)}
                        ...
                        <div className="flex justify-between">
                          ...
                          <span className={`font-medium ${monitoringData.insights.cost_tracking
                .profit_margin > 0.2
                ? "text-green-600"
                : monitoringData.insights.cost_tracking
                    ...
                    ? "text-yellow-600"
                    : "text-red-600"}`}>
                            {Math.round(monitoringData.insights.cost_tracking
                .profit_margin * 100)}
                            %
                          </span>
                        </div>
