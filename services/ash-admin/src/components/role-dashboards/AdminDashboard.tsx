          ...
          <div className="flex items-center justify-between">
            <div className="flex-1">
              ...
              <div className="mt-2 flex items-center text-sm font-medium text-blue-600">
                <HydrationSafeIcon Icon={Package} className="mr-1.5 h-4 w-4" />
        ...
        <div className="stats-card group hover:shadow-lg">
          <div className="flex items-center justify-between">
            <div className="flex-1">
              ...
              <div className="mt-2 flex items-center text-sm font-medium text-purple-600">
                <HydrationSafeIcon
                  Icon={Building2}
                  className="mr-1.5 h-4 w-4"
                />
        ...
        <div className="stats-card group hover:shadow-lg">
          <div className="flex items-center justify-between">
            <div className="flex-1">
              ...
              <div className="mt-2 flex items-center text-sm font-medium text-orange-600">
                <HydrationSafeIcon Icon={Users} className="mr-1.5 h-4 w-4" />
                Active workforce
              </div>
            </div>
        ...
        <div className="modern-card fade-in">
          ...
          <div className="p-6">
            <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
              <Link href="/orders">
                <button className="modern-button flex h-24 w-full flex-col items-center justify-center gap-2.5 rounded-lg border-2 border-primary bg-primary font-semibold text-white transition-all hover:border-primary/90 hover:bg-primary/90 hover:shadow-lg">
                  <HydrationSafeIcon Icon={Package} className="h-6 w-6" />
                  <span className="text-sm">View Orders</span>
                </button>
              </Link>
              <Link href="/clients">
                <button className="modern-button flex h-24 w-full flex-col items-center justify-center gap-2.5 rounded-lg border-2 border-primary bg-primary font-semibold text-white transition-all hover:border-primary/90 hover:bg-primary/90 hover:shadow-lg">
                  <HydrationSafeIcon Icon={Building2} className="h-6 w-6" />
                  <span className="text-sm">Manage Clients</span>
                </button>
              </Link>
              <Link href="/hr-payroll">
                <button className="modern-button flex h-24 w-full flex-col items-center justify-center gap-2.5 rounded-lg border-2 border-primary bg-primary font-semibold text-white transition-all hover:border-primary/90 hover:bg-primary/90 hover:shadow-lg">
                  <HydrationSafeIcon Icon={Users} className="h-6 w-6" />
                  <span className="text-sm">HR & Payroll</span>
                </button>
              </Link>
              <Link href="/finance">
                <button className="modern-button flex h-24 w-full flex-col items-center justify-center gap-2.5 rounded-lg border-2 border-primary bg-primary font-semibold text-white transition-all hover:border-primary/90 hover:bg-primary/90 hover:shadow-lg">
                  <HydrationSafeIcon Icon={DollarSign} className="h-6 w-6" />
                  <span className="text-sm">Finance</span>
                </button>
              </Link>
              <Link href="/cutting">
                <button className="modern-button flex h-24 w-full flex-col items-center justify-center gap-2.5 rounded-lg border-2 border-primary bg-primary font-semibold text-white transition-all hover:border-primary/90 hover:bg-primary/90 hover:shadow-lg">
                  <HydrationSafeIcon Icon={Scissors} className="h-6 w-6" />
                  <span className="text-sm">Cutting</span>
                </button>
              </Link>
              <Link href="/printing">
                <button className="modern-button flex h-24 w-full flex-col items-center justify-center gap-2.5 rounded-lg border-2 border-primary bg-primary font-semibold text-white transition-all hover:border-primary/90 hover:bg-primary/90 hover:shadow-lg">
                  <HydrationSafeIcon Icon={Printer} className="h-6 w-6" />
                  <span className="text-sm">Printing</span>
                </button>
              </Link>
              <Link href="/quality-control">
                <button className="modern-button flex h-24 w-full flex-col items-center justify-center gap-2.5 rounded-lg border-2 border-primary bg-primary font-semibold text-white transition-all hover:border-primary/90 hover:bg-primary/90 hover:shadow-lg">
                  <HydrationSafeIcon Icon={BadgeCheck} className="h-6 w-6" />
                  <span className="text-sm">Quality Control</span>
                </button>
              </Link>
              <Link href="/analytics">
                <button className="modern-button flex h-24 w-full flex-col items-center justify-center gap-2.5 rounded-lg border-2 border-primary bg-primary font-semibold text-white transition-all hover:border-primary/90 hover:bg-primary/90 hover:shadow-lg">
                  <HydrationSafeIcon Icon={TrendingUp} className="h-6 w-6" />
