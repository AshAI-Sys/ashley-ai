      ...
      <Tabs defaultValue="overview" className="space-y-4">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
            ...
            <Card>
              ...
              <CardContent>
                ...
                <Progress
                  value={insights?.insights.capacity.capacity_utilization || 0}
                  className="mt-2"
                />
              </CardContent>
            </Card>
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-1">
                    <div className="flex justify-between text-sm">
                      ...
                      <span>
                        {insights?.insights.capacity.capacity_utilization.toFixed(
                          1
                        )}
                        %
                      </span>
                    ...
                    <Progress
                      value={
                        insights?.insights.capacity.capacity_utilization || 0
                      }
                    />
                  </div>
                </div>
        ...
        <TabsContent value="quality" className="space-y-4">
          <Card>
            ...
            <CardContent className="space-y-4">
              <div
                className={`rounded-lg p-4 ${getRiskColor(insights?.insights.quality.trend || "good")}`}
              >
                <div className="mb-2 flex items-center space-x-2">
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <Progress
                    value={insights?.insights.quality.weekly_pass_rate || 0}
                  />
                </div>
        ...
        <TabsContent value="workforce" className="space-y-4">
          <Card>
            ...
            <CardContent className="space-y-4">
              <div
                className={`rounded-lg p-4 ${getRiskColor(insights?.insights.workforce.data.overall_health || "good")}`}
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-2">
                  ...
                  <Badge
                    className={getConfidenceColor(
                      insights?.insights.workforce.confidence || 0
                    )}
                  >
                    {insights?.insights.workforce.confidence}% confidence
                  </Badge>
                  ...
                  <div className="space-y-2">
                    {insights?.insights.workforce.data.fatigue_alerts?.map(
                      (alert, index) => (
                        <div
                          key={index}
                          className={`rounded-lg p-3 ${getRiskColor(alert.risk_level)}`}
                        >
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                {Object.entries(
                  insights?.insights.workforce.data.department_analysis || {}
                ).map(([dept, status]) => (
                  <div key={dept} className="rounded-lg border p-3">
                    <div className="font-medium capitalize">{dept}</div>
                    <div
                      className={`text-sm ${status === "good" ? "text-green-600" : "text-yellow-600"}`}
                    >
                      {status}
                    </div>
                  </div>
            ...
            <CardContent className="space-y-4">
              <div className="rounded-lg border border-orange-200 bg-orange-50 p-4">
                <div className="mb-2 flex items-center space-x-2">
                  ...
                  <Badge
                    className={getConfidenceColor(
                      insights?.insights.maintenance.confidence || 0
                    )}
                  >
                        ...
                        (maintenance, index) => (
                          ...
                          >
                            ...
                            <div className="text-right">
                              <Badge
                                className={getRiskColor(maintenance.urgency)}
                              >
                                {maintenance.urgency}
                              </Badge>
                              <div className="text-sm text-gray-600">
