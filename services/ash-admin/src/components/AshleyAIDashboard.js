...
exports.AshleyAIDashboard = AshleyAIDashboard;
...
function AshleyAIDashboard() {
    ...
    if (loading)
        return <div className="flex items-center justify-center h-64">Loading Ashley AI insights...</div>;
    if (error)
    ...
    return (<div className="p-6 space-y-6">
      <div className="flex justify-between items-center">
        <div className="flex items-center space-x-3">
          <div className="p-2 bg-purple-100 rounded-lg">
            <lucide_react_1.Brain className="w-6 h-6 text-purple-600"/>
          </div>
          <div>
      ...
      {insights?.summary.high_priority_alerts.length > 0 && (<alert_1.Alert className="border-red-200 bg-red-50">
      ...
      <card_1.Card>
        <card_1.CardHeader>
          ...
          <card_1.CardDescription>Run instant AI analysis on different aspects of your production</card_1.CardDescription>
        </card_1.CardHeader>
        <card_1.CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <button_1.Button onClick={() => runAnalysis('capacity')} disabled={analyzing} className="flex items-center space-x-2">
              <lucide_react_1.Target className="w-4 h-4"/>
              <span>Capacity Analysis</span>
            </button_1.Button>
            <button_1.Button onClick={() => runAnalysis('quality')} disabled={analyzing} className="flex items-center space-x-2">
              <lucide_react_1.Shield className="w-4 h-4"/>
              <span>Quality Prediction</span>
            </button_1.Button>
            <button_1.Button onClick={() => runAnalysis('fatigue')} disabled={analyzing} className="flex items-center space-x-2">
              <lucide_react_1.Users className="w-4 h-4"/>
              <span>Workforce Health</span>
            </button_1.Button>
            <button_1.Button onClick={() => runAnalysis('maintenance')} disabled={analyzing} className="flex items-center space-x-2">
      ...
      <tabs_1.Tabs defaultValue="overview" className="space-y-4">
        <tabs_1.TabsList>
          ...
          <tabs_1.TabsTrigger value="capacity">Capacity Intelligence</tabs_1.TabsTrigger>
          <tabs_1.TabsTrigger value="quality">Quality Intelligence</tabs_1.TabsTrigger>
          <tabs_1.TabsTrigger value="workforce">Workforce Analytics</tabs_1.TabsTrigger>
          <tabs_1.TabsTrigger value="maintenance">Equipment Intelligence</tabs_1.TabsTrigger>
        </tabs_1.TabsList>
        ...
        <tabs_1.TabsContent value="overview" className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <card_1.Card>
              <card_1.CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <card_1.CardTitle className="text-sm font-medium">Capacity Utilization</card_1.CardTitle>
              ...
              <card_1.CardContent>
                ...
                <progress_1.Progress value={insights?.insights.capacity.capacity_utilization || 0} className="mt-2"/>
              </card_1.CardContent>
            </card_1.Card>
            ...
            <card_1.Card>
              ...
              <card_1.CardContent>
                ...
                <div className="flex items-center mt-2">
                  {insights?.insights.quality.trend === 'excellent' ? (<lucide_react_1.TrendingUp className="w-4 h-4 text-green-500"/>) : (<lucide_react_1.TrendingDown className="w-4 h-4 text-red-500"/>)}
                </div>
              </card_1.CardContent>
            </card_1.Card>
            ...
            <card_1.Card>
              <card_1.CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <card_1.CardTitle className="text-sm font-medium">Workforce Health</card_1.CardTitle>
              ...
              <card_1.CardContent>
                ...
                <badge_1.Badge className={`mt-2 ${getRiskColor(insights?.insights.workforce.data.overall_health || 'good')}`}>
            ...
            <card_1.Card>
              <card_1.CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <card_1.CardTitle className="text-sm font-medium">Equipment Status</card_1.CardTitle>
          ...
          <card_1.Card>
            <card_1.CardHeader>
              <card_1.CardTitle className="flex items-center space-x-2">
                <lucide_react_1.Lightbulb className="w-5 h-5 text-yellow-600"/>
                <span>AI Recommendations</span>
              </card_1.CardTitle>
            </card_1.CardHeader>
            <card_1.CardContent>
              <div className="space-y-3">
                {insights?.summary.recommended_actions.map((action, index) => (<div key={index} className="flex items-center space-x-3 p-3 bg-blue-50 rounded-lg">
        ...
        <tabs_1.TabsContent value="capacity" className="space-y-4">
          <card_1.Card>
            <card_1.CardHeader>
              <card_1.CardTitle>Capacity Intelligence</card_1.CardTitle>
              <card_1.CardDescription>AI analysis of production capacity and scheduling</card_1.CardDescription>
            </card_1.CardHeader>
            <card_1.CardContent className="space-y-4">
              <div className="p-4 bg-blue-50 rounded-lg">
                <div className="flex items-center space-x-2 mb-2">
                  <lucide_react_1.Target className="w-5 h-5 text-blue-600"/>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <div className="space-y-1">
                    ...
                    <progress_1.Progress value={insights?.insights.capacity.capacity_utilization || 0}/>
                  </div>
                </div>
        ...
        <tabs_1.TabsContent value="quality" className="space-y-4">
          <card_1.Card>
            <card_1.CardHeader>
              <card_1.CardTitle>Quality Intelligence</card_1.CardTitle>
              <card_1.CardDescription>AI-powered quality analysis and predictions</card_1.CardDescription>
            </card_1.CardHeader>
            <card_1.CardContent className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <progress_1.Progress value={insights?.insights.quality.weekly_pass_rate || 0}/>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center space-x-2">
                    {insights?.insights.quality.trend === 'excellent' ? (<>
                        <lucide_react_1.TrendingUp className="w-5 h-5 text-green-500"/>
                        <span className="text-green-600 font-medium">Excellent</span>
                      </>) : insights?.insights.quality.trend === 'good' ? (<>
                        <lucide_react_1.TrendingUp className="w-5 h-5 text-blue-500"/>
                        <span className="text-blue-600 font-medium">Good</span>
                      </>) : (<>
                        <lucide_react_1.TrendingDown className="w-5 h-5 text-red-500"/>
        ...
        <tabs_1.TabsContent value="workforce" className="space-y-4">
          <card_1.Card>
            <card_1.CardHeader>
              <card_1.CardTitle>Workforce Analytics</card_1.CardTitle>
              <card_1.CardDescription>AI analysis of employee performance and wellbeing</card_1.CardDescription>
            </card_1.CardHeader>
            <card_1.CardContent className="space-y-4">
              <div className={`p-4 rounded-lg ${getRiskColor(insights?.insights.workforce.data.overall_health || 'good')}`}>
                <div className="flex items-center justify-between">
                  ...
                  <badge_1.Badge className={getConfidenceColor(insights?.insights.workforce.confidence || 0)}>
                    {insights?.insights.workforce.confidence}% confidence
                  </badge_1.Badge>
                </div>
              ...
              {insights?.insights.workforce.data.fatigue_alerts.length > 0 && (<div className="space-y-2">
                  <h4 className="font-medium">Fatigue Alerts</h4>
                  <div className="space-y-2">
                    {insights.insights.workforce.data.fatigue_alerts.map((alert, index) => (<div key={index} className={`p-3 rounded-lg ${getRiskColor(alert.risk_level)}`}>
                        <div className="flex justify-between items-start">
                          <div>
                            <span className="font-medium">{alert.employee}</span>
                            <span className="text-sm text-gray-600 ml-2">({alert.department})</span>
                          </div>
                          <badge_1.Badge variant="outline">{alert.risk_level} risk</badge_1.Badge>
                        </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {Object.entries(insights?.insights.workforce.data.department_analysis || {}).map(([dept, status]) => (<div key={dept} className="p-3 border rounded-lg">
        ...
        <tabs_1.TabsContent value="maintenance" className="space-y-4">
          <card_1.Card>
            <card_1.CardHeader>
              <card_1.CardTitle>Equipment Intelligence</card_1.CardTitle>
              <card_1.CardDescription>AI-powered maintenance predictions and recommendations</card_1.CardDescription>
            </card_1.CardHeader>
            <card_1.CardContent className="space-y-4">
              <div className="p-4 bg-orange-50 rounded-lg border border-orange-200">
                <div className="flex items-center space-x-2 mb-2">
                  <lucide_react_1.Wrench className="w-5 h-5 text-orange-600"/>
                  <span className="font-medium">Maintenance Intelligence</span>
                  <badge_1.Badge className={getConfidenceColor(insights?.insights.maintenance.confidence || 0)}>
              ...
              {insights?.insights.maintenance.data.immediate_attention.length > 0 && (<alert_1.Alert className="border-red-200 bg-red-50">
                  <lucide_react_1.AlertTriangle className="h-4 w-4 text-red-600"/>
                  <alert_1.AlertDescription>
              ...
              <div className="grid grid-cols-1 gap-4">
                ...
                {insights?.insights.maintenance.data.maintenance_due.length > 0 && (<div className="space-y-2">
                    <h4 className="font-medium">Scheduled Maintenance</h4>
                    <div className="space-y-2">
                      {insights.insights.maintenance.data.maintenance_due.map((maintenance, index) => (<div key={index} className="flex justify-between items-center p-3 border rounded-lg">
                          <div>
                            <span className="font-medium">{maintenance.asset}</span>
                            <span className="text-sm text-gray-600 ml-2">({maintenance.type})</span>
                          </div>
                          <div className="text-right">
                            <badge_1.Badge className={getRiskColor(maintenance.urgency)}>
                              {maintenance.urgency}
                            </badge_1.Badge>
