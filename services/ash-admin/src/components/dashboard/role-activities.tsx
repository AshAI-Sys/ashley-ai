  ...
  return (
    <div className="space-y-3">
      {activities.map((activity, index) => (
        <div key={index} className={`p-3 bg-gray-50 rounded-md border-l-4 border-${activity.color}-500`}>
          <p className="text-sm font-medium text-gray-900 mb-1">
            {activity.title}
          </p>
          <p className="text-xs text-gray-600">
  ...
  return (
    <div className="space-y-3">
      {tasks.map((task, index) => (
        <div key={index} className={`p-3 bg-gray-50 rounded-md border-l-4 border-${task.color}-500`}>
          <p className="text-sm font-medium text-gray-900 mb-1">
            {task.title}
          </p>
          <p className="text-xs text-gray-600">
