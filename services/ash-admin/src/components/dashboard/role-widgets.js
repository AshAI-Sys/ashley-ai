    ...
    return (<>
      <div className="bg-white rounded-lg p-6 shadow-sm">
        <div className="flex items-center justify-between mb-4">
          ...
          <lucide_react_1.BarChart3 className="w-5 h-5 text-blue-600"/>
        </div>
    ...
    return (<>
      <div className="bg-white rounded-lg p-6 shadow-sm">
        <div className="flex items-center justify-between mb-4">
          ...
          <lucide_react_1.Package className="w-5 h-5 text-blue-600"/>
        </div>
        <div className="space-y-2">
          <div className="flex justify-between text-sm">
      ...
      <div className="bg-white rounded-lg p-6 shadow-sm">
        <div className="flex items-center justify-between mb-4">
          ...
          <lucide_react_1.Users className="w-5 h-5 text-green-600"/>
        </div>
        <div className="space-y-2">
          <div className="flex justify-between text-sm">
...
function SupervisorWidgets({ user }) {
    const getDepartmentIcon = (dept) => {
        switch (dept) {
            case 'Cutting': return <lucide_react_1.Scissors className="w-5 h-5 text-blue-600"/>;
            case 'Printing': return <lucide_react_1.Printer className="w-5 h-5 text-purple-600"/>;
            case 'Sewing': return <lucide_react_1.PocketKnife className="w-5 h-5 text-green-600"/>;
            case 'Quality': return <lucide_react_1.CheckCircle className="w-5 h-5 text-yellow-600"/>;
            case 'Delivery': return <lucide_react_1.Truck className="w-5 h-5 text-red-600"/>;
            case 'Maintenance': return <lucide_react_1.Wrench className="w-5 h-5 text-gray-600"/>;
            default: return <lucide_react_1.Package className="w-5 h-5 text-blue-600"/>;
        }
    };
    return (<>
      <div className="bg-white rounded-lg p-6 shadow-sm">
      ...
      <div className="bg-white rounded-lg p-6 shadow-sm">
        <div className="flex items-center justify-between mb-4">
          ...
          <lucide_react_1.Clock className="w-5 h-5 text-amber-600"/>
        </div>
        <div className="space-y-2">
          <div className="flex justify-between text-sm">
    ...
    return (<>
      ...
      <div className="bg-white rounded-lg p-6 shadow-sm">
        <div className="flex items-center justify-between mb-4">
          ...
          <lucide_react_1.BarChart3 className="w-5 h-5 text-green-600"/>
        </div>
        <div className="space-y-2">
          <div className="flex justify-between text-sm">
            <span className="text-gray-600">Efficiency</span>
    ...
    return (<>
      ...
      <div className="bg-white rounded-lg p-6 shadow-sm">
        <div className="flex items-center justify-between mb-4">
          ...
          <lucide_react_1.Clock className="w-5 h-5 text-green-600"/>
        </div>
        <div className="space-y-2">
          <div className="flex justify-between text-sm">
