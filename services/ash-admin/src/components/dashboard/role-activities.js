...
function ManagerActivities({ user }) {
    ...
    return (<div className="space-y-3">
      {activities.map((activity, index) => (<div key={index} className={`rounded-md border-l-4 bg-gray-50 p-3 border-${activity.color}-500`}>
          <p className="mb-1 text-sm font-medium text-gray-900">
            {activity.title}
          </p>
          <p className="text-xs text-gray-600">
...
function SupervisorActivities({ user }) {
    ...
    return (<div className="space-y-3">
      {tasks.map((task, index) => (<div key={index} className={`rounded-md border-l-4 bg-gray-50 p-3 border-${task.color}-500`}>
...
function OperatorActivities({ user: _user }) {
    return (<div className="space-y-3">
      <div className="rounded-md border-l-4 border-green-500 bg-gray-50 p-3">
        <p className="mb-1 text-sm font-medium text-gray-900">
...
function EmployeeActivities({ user: _user }) {
    return (<div className="space-y-3">
      <div className="rounded-md border-l-4 border-blue-500 bg-gray-50 p-3">
        <p className="mb-1 text-sm font-medium text-gray-900">
