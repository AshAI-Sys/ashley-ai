...
exports.default = RoleActivities;
...
function AdminActivities() {
    return (<div className="space-y-3">
      ...
      <div className="p-3 bg-gray-50 rounded-md border-l-4 border-purple-500">
        ...
        <p className="text-xs text-gray-600">
          4 hours ago • Revenue up 12%
        </p>
      </div>
    </div>);
}
// Manager Recent Activities
function ManagerActivities({ user }) {
    const getDepartmentActivities = (department) => {
        switch (department) {
            case 'Cutting':
                return [
                    {
    ...
    return (<div className="space-y-3">
      {activities.map((activity, index) => (<div key={index} className={`p-3 bg-gray-50 rounded-md border-l-4 border-${activity.color}-500`}>
          <p className="text-sm font-medium text-gray-900 mb-1">
            {activity.title}
          </p>
          <p className="text-xs text-gray-600">
...
function SupervisorActivities({ user }) {
    const getDepartmentTasks = (department) => {
        switch (department) {
            case 'Cutting':
                return [
                    {
    ...
    return (<div className="space-y-3">
      {tasks.map((task, index) => (<div key={index} className={`p-3 bg-gray-50 rounded-md border-l-4 border-${task.color}-500`}>
          <p className="text-sm font-medium text-gray-900 mb-1">
            {task.title}
          </p>
          <p className="text-xs text-gray-600">
...
function OperatorActivities({ user }) {
    return (<div className="space-y-3">
      <div className="p-3 bg-gray-50 rounded-md border-l-4 border-green-500">
        <p className="text-sm font-medium text-gray-900 mb-1">
...
function EmployeeActivities({ user }) {
    return (<div className="space-y-3">
      <div className="p-3 bg-gray-50 rounded-md border-l-4 border-blue-500">
        <p className="text-sm font-medium text-gray-900 mb-1">
