    ...
    <Card className="w-full max-w-2xl mx-auto">
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
          ...
          Proof of Delivery
          {deliveryReference && (
            <span className="text-sm text-gray-500 ml-2">({deliveryReference})</span>
          )}
        </CardTitle>
      </CardHeader>
      <CardContent className="space-y-6">
        ...
        <div className="space-y-4">
          <h3 className="text-sm font-semibold text-gray-700">Recipient Information</h3>
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <FileUpload
              ...
              type="image"
              existingUrls={formData.signature_url ? [formData.signature_url] : []}
        ...
        {/* Delivery Photos */}
        <div className="space-y-4">
          <h3 className="text-sm font-semibold text-gray-700">Delivery Photos</h3>
          <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              ...
              <Input
                ...
                onChange={(e) => setFormData({...formData, cod_amount: parseFloat(e.target.value) || null})}
                placeholder="0.00"
              />
            </div>
            <div>
              ...
              <Input
                ...
                onChange={(e) => setFormData({...formData, cod_collected: parseFloat(e.target.value) || null})}
                placeholder="0.00"
              />
            </div>
            <div>
              ...
              <Input
                ...
                onChange={(e) => setFormData({...formData, cod_reference: e.target.value})}
