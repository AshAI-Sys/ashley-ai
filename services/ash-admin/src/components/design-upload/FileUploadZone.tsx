...
export default function FileUploadZone({
  ...
  const validateFile = (file: File): string | null => {
    ...
    const isValidType =
      validTypes[fileType]?.includes(file.type) ||
      (fileType === "embroidery" &&
  ...
  return (
    <div className={`space-y-4 ${className}`}>
      <div>
        ...
        <div
          className="cursor-pointer rounded-lg border-2 border-dashed border-gray-300 p-6 transition-colors hover:border-blue-400"
          onDrop={handleDrop}
