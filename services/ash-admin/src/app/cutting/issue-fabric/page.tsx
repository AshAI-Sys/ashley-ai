...
export default function IssueFabricPage() {
  ...
  const validateForm = () => {
    ...
    if (!formData.qty_issued) newErrors.qty_issued = 'Quantity to issue is required'
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Select the order that will use this fabric</CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Specify how much fabric to transfer to cutting</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
