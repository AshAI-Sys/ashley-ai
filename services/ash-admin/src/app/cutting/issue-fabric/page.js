      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <card_1.Card>
          ...
          <card_1.CardContent className="space-y-4">
            ...
            {selectedBatch && (<div className="rounded-lg bg-green-50 p-4">
                <div className="mb-2 flex items-center gap-2">
          ...
          <card_1.CardContent className="space-y-4">
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              <div className="space-y-2">
                ...
                {errors.qty_issued && (<p className="text-sm text-red-600">{errors.qty_issued}</p>)}
              </div>
            ...
            {/* Quantity Summary */}
            {selectedBatch && requestedQuantity > 0 && (<div className="rounded-lg bg-gray-50 p-4">
                ...
                {remainingQuantity < 0 && (<div className="mt-4 flex items-start gap-2 rounded-lg border border-red-200 bg-red-50 p-3">
                ...
                {remainingQuantity >= 0 && requestedQuantity > 0 && (<div className="mt-4 flex items-start gap-2 rounded-lg border border-green-200 bg-green-50 p-3">
                    <lucide_react_1.CheckCircle className="mt-0.5 h-5 w-5 text-green-600"/>
                    <div>
