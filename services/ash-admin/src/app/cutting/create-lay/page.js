...
function CreateLayPage() {
    ...
    const calculateMetrics = () => {
        ...
        const expectedPieces = width && length && plies
            ? Math.floor((width * length * plies) / 2500)
            : 0; // 2500 cm² per piece estimate
        const efficiency = grossUsed > 0
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <card_1.Card>
          ...
          <card_1.CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              {errors.order_id && (<p className="text-sm text-red-600">{errors.order_id}</p>)}
            </div>
        ...
        <card_1.Card>
          ...
          <card_1.CardContent className="space-y-4">
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              ...
              <div className="space-y-2">
                <label_1.Label htmlFor="marker_width_cm">
                  Marker Width (cm, optional)
                </label_1.Label>
                <input_1.Input id="marker_width_cm" type="number" value={formData.marker_width_cm} onChange={e => setFormData({
            ...formData,
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
              <div className="space-y-2">
                ...
                {errors.lay_length_m && (<p className="text-sm text-red-600">{errors.lay_length_m}</p>)}
              </div>
              ...
              <div className="space-y-2">
                ...
                {errors.plies && (<p className="text-sm text-red-600">{errors.plies}</p>)}
              </div>
        ...
        <card_1.Card>
          ...
          <card_1.CardContent className="space-y-4">
            <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
              <div className="space-y-2">
                <label_1.Label htmlFor="gross_used">
                ...
                {errors.gross_used && (<p className="text-sm text-red-600">{errors.gross_used}</p>)}
              </div>
        ...
        <card_1.Card>
          ...
          <card_1.CardContent className="space-y-4">
            {outputs.map((output, index) => (<div key={index} className="flex items-end gap-4">
                <div className="flex-1 space-y-2">
                  ...
                  {errors[`output_${index}_size`] && (<p className="text-sm text-red-600">
            ...
            {errors.outputs && (<p className="text-sm text-red-600">{errors.outputs}</p>)}
          </card_1.CardContent>
        </card_1.Card>
        ...
        <card_1.Card>
          ...
          <card_1.CardContent>
            <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
              ...
              <div className={`rounded-lg p-3 text-center ${calculations.efficiency >= 78 ? "bg-green-50" : "bg-orange-50"}`}>
                <p className={`text-2xl font-bold ${calculations.efficiency >= 78
            ? "text-green-600"
            : "text-orange-600"}`}>
              ...
              <div className={`rounded-lg p-3 text-center ${calculations.waste <= 8 ? "bg-green-50" : "bg-red-50"}`}>
            ...
            {calculations.efficiency < 78 && (<div className="mt-4 flex items-start gap-2 rounded-lg border border-orange-200 bg-orange-50 p-3">
