...
exports.createValidationErrorResponse = exports.POST = exports.GET = void 0;
/* eslint-disable */
...
exports.GET = (0, auth_middleware_1.requireAuth)(async (request, user) => {
    try {
        ...
        if (workspaceError) {
            return (0, exports.createValidationErrorResponse)([workspaceError]);
        }
        ...
        if (limitError) {
            return (0, exports.createValidationErrorResponse)([limitError]);
        }
        ...
        const trendStats = {
            ...
            avg_impact: trends.reduce((sum, trend) => sum + trend.impact_score, 0) /
                trends.length,
            avg_confidence: trends.reduce((sum, trend) => sum + trend.confidence_score, 0) /
                trends.length,
        };
