...
exports.GET = (0, auth_middleware_1.requireAuth)(async (req, _user) => {
    try {
        ...
        if (isFavorite !== null)
            where.is_favorite = isFavorite === "true";
        ...
        export const POST = (0, auth_middleware_1.requireAuth)(async (req, user) => {
            try {
                ...
                const { name, description, report_type, data_source, query_config, visualization, columns, filters, sort_order, schedule, schedule_config, is_public, } = body;
