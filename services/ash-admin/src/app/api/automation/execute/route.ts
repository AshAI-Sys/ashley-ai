...
async function executeActions(actions: any[], triggerData: any, workspaceId: string): Promise<any[]> {
  const results = [];
...
async function executeAction(action: any, triggerData: any, workspaceId: string): Promise<any> {
...
async function sendNotification(config: any, triggerData: any, workspaceId: string) {
...
async function updateOrderStatus(config: any, triggerData: any, workspaceId: string) {
