...
const _OnboardingStepSchema = zod_1.z.object({
    step: zod_1.z.enum([
        "personal_info",
        "role_assignment",
        "department_setup",
