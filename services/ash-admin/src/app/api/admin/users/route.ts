...
const CreateUserSchema = z.object({
  ...
  role: z.enum(['admin', 'manager', 'designer', 'cutting_operator', 'printing_operator', 'sewing_operator', 'qc_inspector', 'finishing_operator', 'warehouse_staff', 'finance_staff', 'hr_staff', 'maintenance_tech']),
