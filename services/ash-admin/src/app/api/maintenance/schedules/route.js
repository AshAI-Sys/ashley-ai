        ...
        if$3(search);
        {
            ...
            const processedSchedules = schedules.map(schedule => {
                ...
                return {
                    ...
                    last_completed: schedule.last_completed?.toISOString() ||
...
exports.POST = (0, auth_middleware_1.requireAuth)(async (request, user) => {
    try {
        ...
        if (!asset_id ||
            ...
            return server_1.NextResponse.json({
                success: false,
                error: "Missing required fields: asset_id, schedule_name, maintenance_type, frequency_type, frequency_value",
            }, { status: 400 });
        }
