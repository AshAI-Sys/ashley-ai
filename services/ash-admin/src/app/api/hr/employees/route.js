...
exports.GET = (0, auth_middleware_1.requireAnyPermission)(['hr:read'])((0, error_handling_1.withErrorHandling)(async (request, user) => {
...
exports.POST = (0, auth_middleware_1.requireAnyPermission)(['hr:write'])((0, error_handling_1.withErrorHandling)(async (request, user) => {
