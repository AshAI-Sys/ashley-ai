            ...
            {!is2FAEnabled ? (
              <div className="space-y-4">
                ...
                <button
                  ...
                  disabled={loading}
                  className="bg-green-600 text-white px-6 py-3 rounded-md font-medium hover:bg-green-700 transition-colors disabled:opacity-50 flex items-center"
                >
                  {loading ? (
              ...
              <div className="space-y-4">
                ...
                <div className="flex space-x-3">
                  ...
                  <button
                    ...
                    disabled={loading}
                    className="bg-red-600 text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-red-700 transition-colors disabled:opacity-50 flex items-center"
                  >
                    {loading ? (
                      <RefreshCw className="w-4 h-4 mr-2 animate-spin" />
                    ) : (
                ...
                {showBackupCodes && (
                  <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      {['ABC12345', 'DEF67890', 'GHI11111', 'JKL22222', 'MNO33333'].map((code, index) => (
          ...
          <div className="space-y-4">
            ...
            <div className="bg-blue-50 p-3 rounded">
              ...
              <ol className="text-xs text-blue-700 space-y-1">
                {twoFactorData.instructions?.map((instruction: string, index: number) => (
        ...
        {step === 2 && (
          <div className="space-y-4">
            ...
            <input
              ...
              placeholder="000000"
              className="w-full px-4 py-3 border border-gray-300 rounded-md text-center text-lg font-mono focus:ring-2 focus:ring-blue-500"
            />
            ...
            <div className="flex space-x-3">
              ...
              <button
                ...
                className="flex-1 bg-blue-600 text-white py-2 rounded-md hover:bg-blue-700 transition-colors disabled:opacity-50 flex items-center justify-center"
              >
                {loading ? (
