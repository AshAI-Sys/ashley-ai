  ...
  const categories = [
    {
      key: "orders" as const,
      label: "Orders & Intake",
      description: "New orders, status changes, approvals",
    },
    {
      key: "production" as const,
      label: "Production",
      description: "Cutting, printing, sewing updates",
    },
    {
      key: "quality" as const,
      label: "Quality Control",
      description: "Inspections, defects, CAPA tasks",
    },
    {
      key: "delivery" as const,
      label: "Delivery",
      description: "Shipments, tracking, proof of delivery",
    },
    {
    ...
    },
    {
      key: "hr" as const,
      label: "HR & Payroll",
      description: "Attendance, payroll, employee updates",
    },
    {
      key: "maintenance" as const,
      label: "Maintenance",
      description: "Work orders, asset alerts, schedules",
    },
    {
      key: "system" as const,
      label: "System",
