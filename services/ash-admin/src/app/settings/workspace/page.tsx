      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center gap-6">
          <div className="relative">
            <div className="flex h-24 w-24 items-center justify-center overflow-hidden rounded-lg border-2 border-gray-300 bg-gray-200 dark:border-gray-600 dark:bg-gray-700">
              {logoPreview ? (
                <img
                  src={logoPreview}
                  alt="Logo"
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            ...
            <div className="md:col-span-2">
              ...
              <textarea
                ...
                rows={3}
                className="w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-gray-900 placeholder-gray-500 dark:border-gray-600 dark:bg-gray-800 dark:text-white dark:placeholder-gray-400"
              />
            </div>
