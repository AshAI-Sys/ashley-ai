...
function CAPAPage() {
    ...
    const getPriorityBadge = (priority) => {
        ...
        return (<span className={`inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium ${colors[priority] || "bg-gray-100 text-gray-800"}`}>
        {priority}
      </span>);
    };
    const getTypeBadge = (type) => {
        return (<span className={`inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium ${type === "CORRECTIVE"
    ...
    return (<div className="min-h-screen bg-gray-50">
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        {/* Analytics Cards */}
        {analytics && (<div className="mb-8 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="overflow-hidden rounded-lg bg-white shadow">
              <div className="p-5">
                ...
                ? Math.round(((analytics.effectiveness_distribution.find(e => e.effectiveness === "EFFECTIVE")?._count.id || 0) /
                    analytics.effectiveness_distribution.reduce((sum, e) => sum + e._count.id, 0)) *
                    100)
                : 0}
                        %
                      </dd>
          ...
          <div className="px-6 py-4">
            <div className="flex flex-col space-y-4 sm:flex-row sm:items-center sm:justify-between sm:space-y-0">
              <div className="flex flex-col space-y-4 sm:flex-row sm:items-center sm:space-x-4 sm:space-y-0">
                ...
                <select className="rounded-md border border-gray-300 px-3 py-2 focus:border-blue-500 focus:ring-blue-500" value={selectedType} onChange={e => setSelectedType(e.target.value)}>
            ...
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="divide-y divide-gray-200 bg-white">
                ...
                : "Unassigned"}
                    ...
                    <td className="whitespace-nowrap px-6 py-4">
                      {task.due_date ? (<div className={`text-sm ${isOverdue(task.due_date) ? "font-medium text-red-600" : "text-gray-900"}`}>
