      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <card_1.Card>
          <card_1.CardHeader>
            ...
            <card_1.CardDescription>Select the order and routing step for this print run</card_1.CardDescription>
          </card_1.CardHeader>
          <card_1.CardContent className="space-y-4">
            ...
            {selectedOrder && (<div className="space-y-2">
                ...
                {errors.routing_step_id && (<p className="text-red-600 text-sm">{errors.routing_step_id}</p>)}
              </div>)}
          </card_1.CardContent>
        </card_1.Card>
        ...
        {formData.routing_step_id && (<card_1.Card>
            <card_1.CardHeader>
              ...
              <card_1.CardDescription>Choose the printing method for this run</card_1.CardDescription>
            </card_1.CardHeader>
            <card_1.CardContent>
              {formData.method ? (<div className="space-y-4">
                  ...
                  {formData.method !== selectedOrder?.routing_steps.find(s => s.id === selectedStep)?.operation_type && (<div className="text-sm text-blue-600">
                      ℹ️ Method automatically selected based on routing step
                    </div>)}
                </div>) : (<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {Object.entries(methodIcons).map(([method, Icon]) => (<button key={method} type="button" className="flex items-center gap-3 p-4 border rounded-lg hover:border-blue-500 hover:bg-blue-50 transition-colors text-left" onClick={() => setFormData({ ...formData, method })}>
        ...
        {formData.method && (<card_1.Card>
            <card_1.CardHeader>
              ...
              <card_1.CardDescription>Select machine and set target quantity</card_1.CardDescription>
            </card_1.CardHeader>
            <card_1.CardContent className="space-y-4">
