...
function PrintRunDetailsPage() {
    ...
    if (loading) {
        ...
        <div className="flex h-64 items-center justify-center">
          <div className="text-center">
            <lucide_react_1.Clock className="mx-auto mb-4 h-8 w-8 animate-pulse"/>
    ...
    if (!run) {
        ...
        <card_1.Card>
          <card_1.CardContent className="flex h-64 items-center justify-center">
            <div className="text-center">
              <lucide_react_1.AlertCircle className="mx-auto mb-4 h-8 w-8 text-red-500"/>
              <p className="text-red-600">Print run not found</p>
              <link_1.default href="/printing">
                <button_1.Button className="mt-4" variant="outline">
                  Back to Printing
                </button_1.Button>
              </link_1.default>
            </div>
    ...
    return (<div className="container mx-auto max-w-6xl space-y-6 py-6">
      {/* Header */}
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-4">
        ...
        <card_1.Card>
          ...
          <card_1.CardContent>
            ...
            {run.rejected_qty + qualityData.qty_reject > 0 && (<p className="mt-1 text-xs text-red-600">
      ...
      <tabs_1.Tabs defaultValue="tracking" className="space-y-6">
            ...
            <card_1.Card>
              ...
              <card_1.CardContent>
                {run.order.bundles.length > 0 ? (<div className="space-y-2">
                    {run.order.bundles.map(bundle => (<div key={bundle.id} className="flex items-center justify-between rounded border p-2">
                        <div>
                    ...
                    <lucide_react_1.Package2 className="mx-auto mb-2 h-8 w-8"/>
        ...
        <tabs_1.TabsContent value="ashley-ai" className="space-y-4">
          <AshleyAIOptimization_1.default runId={runId} printMethod={run.method} quantity={run.target_qty} materials={materialData} machineId={run.machine?.id} orderData={{
            quality_requirements: run.order.line_items[0]?.description?.includes("premium")
                ? { high_quality: true }
                : {},
            rush_order: run.created_at &&
        ...
        <tabs_1.TabsContent value="quality" className="space-y-4">
          <card_1.Card>
            ...
            <card_1.CardContent className="space-y-4">
              ...
              {qualityData.reject_reasons.map((reason, index) => (<div key={index} className="grid grid-cols-4 gap-4 rounded border p-4">
                  <div className="space-y-2">
                    <label_1.Label>Reason</label_1.Label>
                    <select className="w-full rounded border p-2" value={reason.reason_code} onChange={e => updateRejectReason(index, "reason_code", e.target.value)}>
                  ...
                  <div className="space-y-2">
                    ...
                    <select className="w-full rounded border p-2" value={reason.cost_attribution} onChange={e => updateRejectReason(index, "cost_attribution", e.target.value)}>
              ...
              {qualityData.reject_reasons.length === 0 && (<div className="py-8 text-center text-muted-foreground">
