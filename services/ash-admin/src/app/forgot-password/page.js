...
function ForgotPasswordPage() {
    ...
    const [resetUrl, setResetUrl] = (0, react_1.useState)("");
    // Force light mode
    (0, react_1.useEffect)(() => {
          ...
          <div className="text-center">
            ...
            <div className="mb-6 rounded-lg border-2 border-blue-300 bg-blue-50 p-4">
              <div className="flex items-start gap-3">
                <lucide_react_1.Mail className="mt-0.5 h-5 w-5 flex-shrink-0 text-blue-600"/>
            ...
            {resetUrl && (<div className="mb-6 rounded-lg border-2 border-green-300 bg-green-50 p-4">
                ...
                <a href={resetUrl} className="inline-block w-full rounded-lg bg-green-600 px-4 py-3 text-center font-semibold text-white transition-colors hover:bg-green-700">
                  Reset Password Now
                </a>
            ...
            <button onClick={() => router.push("/login")} className="w-full rounded-lg bg-corporate-blue py-3 font-semibold text-white shadow-corporate transition-all hover:bg-blue-700 hover:shadow-corporate-hover">
              Back to Login
            </button>
          </div>
        </div>
      ...
      <div className="corporate-card w-full max-w-md p-10">
        <div className="mb-8 text-center">
          <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-xl bg-corporate-blue shadow-corporate">
            <lucide_react_1.Mail className="h-7 w-7 text-white"/>
          </div>
        ...
        <div className="border-t border-gray-200 pt-6 text-center">
          <link_1.default href="/login" className="inline-flex items-center gap-1 text-sm font-semibold transition-colors" style={{ color: "#374151" }}>
