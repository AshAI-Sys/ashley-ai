...
function DesignDetailsPage() {
    ...
    const placements = currentVersion
        ...
        : [];
    const palette = currentVersion && currentVersion.palette
    ...
    return (<div className="container mx-auto py-6">
      ...
      <div className="mb-6 flex border-b">
        {[
            ...
            const Icon = tab.icon;
            return (<button key={tab.id} className={`flex items-center gap-2 border-b-2 px-4 py-2 transition-colors ${activeTab === tab.id
        ...
        <div className="space-y-6 lg:col-span-2">
          ...
          {activeTab === "overview" && (<>
              ...
              <card_1.Card>
                ...
                <card_1.CardContent className="space-y-4">
                  {files.mockup_url && (<div className="flex items-center justify-between rounded bg-gray-50 p-3">
                      <div className="flex items-center gap-2">
                        <lucide_react_1.Image className="h-5 w-5 text-blue-600"/>
                  ...
                  {files.prod_url && (<div className="flex items-center justify-between rounded bg-gray-50 p-3">
                      <div className="flex items-center gap-2">
                  ...
                  {files.separations && files.separations.length > 0 && (<div>
                      ...
                      {files.separations.map((url, index) => (<div key={index} className="mb-2 flex items-center justify-between rounded bg-gray-50 p-3">
                          <div className="flex items-center gap-2">
                  ...
                  {files.dst_url && (<div className="flex items-center justify-between rounded bg-gray-50 p-3">
                      <div className="flex items-center gap-2">
                        <lucide_react_1.FileText className="h-5 w-5 text-pink-600"/>
              ...
              <card_1.Card>
                ...
                <card_1.CardContent>
                  <div className="space-y-3">
                    {placements.map((placement, index) => (<div key={index} className="rounded border p-3">
                  ...
                  <card_1.CardContent>
                    <div className="flex flex-wrap gap-3">
                      {palette.map((color, index) => (<div key={index} className="flex items-center gap-2">
                          <div className="h-8 w-8 rounded border border-gray-300" style={{ backgroundColor: color }}/>
          ...
          {activeTab === "versions" && (<card_1.Card>
              ...
              <card_1.CardContent>
                ...
                return (<div key={version.id} className="rounded-lg border p-4">
                          ...
                          <div className="text-sm text-muted-foreground">
                            ...
                            <p>
                              Files:{" "}
                              {Object.keys(versionFiles).filter(key => versionFiles[key]).length}{" "}
                              files uploaded
                            </p>
                          </div>
                        </div>);
          ...
          {activeTab === "approvals" && (<card_1.Card>
              ...
              <card_1.CardContent className="space-y-4">
                ...
                .map(approval => (<div key={approval.id} className="rounded-lg border p-4">
                        <div className="mb-2 flex items-center justify-between">
                          <div className="flex items-center gap-2">
                        ...
                        {approval.comments && (<div className="mt-2 rounded bg-gray-50 p-2">
          ...
          {activeTab === "validation" && (<card_1.Card>
              ...
              <card_1.CardContent className="space-y-4">
                ...
                const metrics = check.metrics
                    ...
                    : {};
                return (<div key={check.id} className="rounded-lg border p-4">
                          <div className="mb-3 flex items-center justify-between">
                            <div className="flex items-center gap-2">
                          ...
                          {issues.length > 0 && (<div className="mb-3">
                              ...
                              <ul className="space-y-1">
                                {issues.map((issue, index) => (<li key={index} className="flex items-start gap-2 text-sm">
                                    <lucide_react_1.AlertCircle className="mt-0.5 h-4 w-4 flex-shrink-0 text-amber-500"/>
                          ...
                          {Object.keys(metrics).length > 0 && (<div>
                              ...
                              <div className="grid grid-cols-2 gap-2 text-sm md:grid-cols-3">
                                {Object.entries(metrics).map(([key, value]) => (<div key={key} className="rounded bg-gray-50 p-2">
                    ...
                    <lucide_react_1.Zap className="mx-auto mb-4 h-12 w-12 text-muted-foreground"/>
                    <p className="mb-4 text-muted-foreground">
