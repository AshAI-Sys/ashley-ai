        ...
        {versions.length > 0 ? (
          versions
            ...
            .map(version => {
              ...
              const latestCheck = versionChecks.sort((a, b) => 
                  ...
                  <CardHeader>
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        {latestCheck && (
                          <Badge className={getCheckResultColor(latestCheck.result)}>
                    ...
                    {palette.length > 0 && (
                      <div>
                        ...
                        <div className="flex gap-1">
                          {palette.slice(0, 8).map((color: string, index: number) => (
                            <div
                              key={index}
                          ...
                          {palette.length > 8 && (
                            <div className="w-6 h-6 border border-gray-300 rounded flex items-center justify-center text-xs bg-gray-100">
                              +{palette.length - 8}
                            </div>
                          )}
                        </div>
