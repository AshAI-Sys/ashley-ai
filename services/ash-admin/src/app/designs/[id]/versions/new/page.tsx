...
export default function NewVersionPage() {
  ...
  const handleFileUpload = useCallback(async (file: File, type: keyof typeof versionData.files, index?: number) => {
  ...
  const handleDrop = useCallback((e: React.DragEvent, type: keyof typeof versionData.files) => {
    e.preventDefault()
  ...
  const runAshleyValidation = async () => {
    ...
    const hasFiles = Object.values(versionData.files).some(fileArray => 
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (response.ok) {
        toast.success(`Version ${design.current_version + 1} created successfully`)
  ...
  const DropZone = ({ type, children }: { type: keyof typeof versionData.files, children: React.ReactNode }) => (
    <div
  ...
  const FileList = ({ type, title }: { type: keyof typeof versionData.files, title: string }) => (
    <div>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Describe the changes in this new version</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div>
                ...
                <Textarea
                  ...
                  onChange={(e) => setVersionData(prev => ({
                    ...prev,
            ...
            <CardHeader>
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <CardDescription>Upload new or updated files for this version</CardDescription>
                </div>
                <Button 
