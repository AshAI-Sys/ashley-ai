...
function DesignApprovalPage() {
    ...
    const getStatusIcon = (status) => {
        ...
        switch (status.toUpperCase()) {
            ...
            case "CHANGES_REQUESTED":
                return <lucide_react_1.MessageCircle className="h-4 w-4"/>;
            case "EXPIRED":
            ...
            <card_1.CardContent className="space-y-4">
              ...
              <div className="rounded-lg bg-gray-50 p-3">
                <div className="mb-2 flex items-center gap-2">
                  <lucide_react_1.Users className="h-4 w-4 text-gray-600"/>
                ...
                <div className="flex items-center justify-between rounded-lg border p-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        ...
                        {activeApproval.expires_at && (<>
                            {" • "}
                            Expires:{" "}
                            {new Date(activeApproval.expires_at).toLocaleDateString()}
                          </>)}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-2">
                    ...
                    <button_1.Button size="sm" variant="outline" onClick={() => openApprovalLink(activeApproval.portal_token)}>
                      <lucide_react_1.ExternalLink className="mr-1 h-4 w-4"/>
                      Open Portal
                    </button_1.Button>
                  </div>
                </div>

                {activeApproval.comments && (<div className="rounded-lg bg-gray-50 p-3">
            ...
            <card_1.CardHeader>
              <div className="flex items-center justify-between">
                ...
                <button_1.Button size="sm" variant="outline" onClick={() => fetchApprovalHistory(design.id)}>
                  <lucide_react_1.RefreshCw className="mr-1 h-4 w-4"/>
                  Refresh
                </button_1.Button>
              </div>
            </card_1.CardHeader>
              ...
              {design.approvals.length > 0 ? (<div className="space-y-4">
                ...
                .map(approval => (<div key={approval.id} className="rounded-lg border p-4">
                        ...
                        <div className="space-y-2 text-sm">
                          ...
                          {approval.approver_name && (<p>
                              <strong>Approved by:</strong>{" "}
                              {approval.approver_name}
                            </p>)}
                          {approval.expires_at && (<p>
                              <strong>Expires:</strong>{" "}
                              {new Date(approval.expires_at).toLocaleDateString()}
                            </p>)}
                        </div>

                        {approval.comments && (<div className="mt-3 rounded bg-gray-50 p-3">
                            <p className="mb-1 text-sm font-medium">
                              Comments:
                            </p>
