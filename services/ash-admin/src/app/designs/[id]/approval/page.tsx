          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <Button 
                ...
                disabled={submitting || !emailSubject.trim() || !customMessage.trim()}
                className="w-full"
              >
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between p-3 border rounded-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        <Badge className={getStatusColor(activeApproval.status)}>
                  ...
                  <div className="flex gap-2">
                    <Button
                      size="sm"
                      variant="outline"
                      onClick={() => copyApprovalLink(activeApproval.portal_token)}
                    >
                    ...
                    <Button
                      size="sm"
                      variant="outline"
                      onClick={() => openApprovalLink(activeApproval.portal_token)}
                    >
                    ...
                    .map(approval => (
                      <div key={approval.id} className="border rounded-lg p-4">
                          ...
                          {approval.status === 'SENT' && (
                            <div className="flex gap-2">
                              <Button
                                size="sm"
                                variant="outline"
                                onClick={() => copyApprovalLink(approval.portal_token)}
                              >
                              ...
                              <Button
                                size="sm"
                                variant="outline"
                                onClick={() => openApprovalLink(approval.portal_token)}
                              >
                        ...
                        <div className="text-sm space-y-2">
                          ...
                          {approval.expires_at && (
                            <p><strong>Expires:</strong> {new Date(approval.expires_at).toLocaleDateString()}</p>
                          )}
                        </div>
