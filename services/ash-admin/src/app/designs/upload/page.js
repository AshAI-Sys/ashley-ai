    ...
    return (<div className="container mx-auto py-6">
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <card_1.Card>
            <card_1.CardHeader>
              ...
              <card_1.CardDescription>Link this design to an order and provide basic details</card_1.CardDescription>
            </card_1.CardHeader>
          ...
          <card_1.Card>
            <card_1.CardHeader>
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <card_1.CardDescription>Upload or link to your design files</card_1.CardDescription>
                </div>
              </div>
            </card_1.CardHeader>
            <card_1.CardContent className="space-y-4">
            ...
            files: { ...formData.files, prod_url: e.target.value }
              ...
              {formData.method === 'SILKSCREEN' && (<div>
                  ...
                  {formData.files.separations.map((separation, index) => (<div key={index} className="flex gap-2 mb-2">
          ...
          <card_1.Card>
            <card_1.CardHeader>
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <card_1.CardDescription>Specify where and how the design will be placed</card_1.CardDescription>
                </div>
            ...
            <card_1.CardContent className="space-y-4">
              {placements.map((placement, index) => (<div key={placement.id} className="border rounded-lg p-4 space-y-4">
                  <div className="flex justify-between items-center">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {formData.palette.map((color, index) => (<div key={index} className="flex items-center gap-2">
                      <input type="color" value={color} onChange={(e) => updateColor(index, e.target.value)} className="w-8 h-8 border border-gray-300 rounded"/>
        ...
        <div className="space-y-6">
          ...
          {/* Actions */}
          <card_1.Card>
            <card_1.CardContent className="pt-6 space-y-3">
