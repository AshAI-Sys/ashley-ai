  ...
  return (
    <div className="container mx-auto py-6">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">Create a new design asset with files and specifications</p>
      </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Link this design to an order and provide basic details</CardDescription>
            </CardHeader>
              ...
              <div>
                ...
                {selectedOrder && (
                  <div className="mt-2 text-sm text-muted-foreground">
                    Brand: {selectedOrder.brand.name} ({selectedOrder.brand.code})
                  </div>
                )}
              </div>
            ...
            <CardHeader>
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <CardDescription>Upload or link to your design files</CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              {formData.method === 'SILKSCREEN' && (
                <div>
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <Button type="button" onClick={addSeparation} size="sm" variant="outline">
            ...
            <CardHeader>
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <CardDescription>Specify where and how the design will be placed</CardDescription>
                </div>
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => setFormData({
                    ...formData,
                    meta: { ...formData.meta, dpi: parseInt(e.target.value) || 300 }
                  })}
                  min="72"
                />
              </div>
