...
function DesignsPage() {
    const [designs, setDesigns] = (0, react_1.useState)([]);
    ...
    return (<dashboard_layout_1.default>
        ...
        <card_1.CardContent className="py-4">
          <div className="flex gap-4 items-center">
            ...
            <div className="flex items-center gap-2">
              ...
              <select value={methodFilter} onChange={(e) => setMethodFilter(e.target.value)} className="px-3 py-2 border border-gray-200 rounded-md text-sm">
      ...
      {loading ? (<div className="flex justify-center py-12">
          ...
          {(designs || []).map((design) => (<card_1.Card key={design.id} className="hover:shadow-md transition-shadow">
              <card_1.CardContent className="py-4">
                <div className="flex justify-between items-start">
                  ...
                  <div className="flex gap-2">
                    ...
                    {design.status === 'DRAFT' && (<button_1.Button variant="outline" size="sm" onClick={() => handleSendApproval(design.id, design.current_version)}>
                        <lucide_react_1.Send className="w-4 h-4 mr-1"/>
                        Send Approval
                      </button_1.Button>)}
