...
import { ArrowLeft, Plus, Building2, Edit, Image, ToggleLeft, ToggleRight, Save, X } from 'lucide-react'
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (editingBrand) {
        ...
        response = await api.updateClientBrand(clientId, editingBrand.id, payload)
      } else {
        // Create new brand
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-4">
                <Label className="text-base font-semibold">Brand Settings</Label>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex gap-2">
                      <Input
                        ...
                        onChange={(e) => handleInputChange('settings.color_primary', e.target.value)}
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex gap-2">
                      <Input
                        ...
                        onChange={(e) => handleInputChange('settings.color_secondary', e.target.value)}
                        className="w-16 h-10 p-1"
                      />
                      <Input
                        type="text"
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleInputChange('settings.notes', e.target.value)}
              ...
              <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                <div>
                  <Label className="text-base font-semibold">Brand Status</Label>
                ...
                <CardContent className="py-4">
                  <div className="flex justify-between items-start">
                    <div className="flex-1">
                      ...
                      {settings?.notes && (
                        <p className="text-sm text-muted-foreground mb-3">{settings.notes}</p>
                      )}
