    ...
    return (<div className="container mx-auto py-6">
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex gap-2">
          ...
          <button_1.Button variant="outline" onClick={handleDelete} disabled={deleting} className="text-red-600 hover:text-red-700 hover:bg-red-50">
        ...
        <card_1.Card>
          ...
          <card_1.CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-2">
                  <lucide_react_1.CreditCard className="w-4 h-4 text-muted-foreground"/>
                  <div>
            ...
            {formatAddress(client.address) && (<div className="mt-6 pt-6 border-t">
                <div className="flex items-start gap-2">
                  <lucide_react_1.MapPin className="w-4 h-4 text-muted-foreground mt-0.5"/>
                  <div>
        ...
        {client.brands && client.brands.length > 0 && (<card_1.Card>
            ...
            <card_1.CardContent>
              <div className="space-y-3">
                {client.brands.slice(0, 5).map((brand) => (<div key={brand.id} className="flex items-center justify-between p-3 border rounded-lg">
                    <div className="flex items-center gap-3">
                      <lucide_react_1.Building2 className="w-4 h-4 text-muted-foreground"/>
                      <div>
                        <p className="font-medium">{brand.name}</p>
                        {brand.code && (<p className="text-sm text-muted-foreground">Code: {brand.code}</p>)}
                      </div>
                    </div>
                    <div className="flex items-center gap-2">
