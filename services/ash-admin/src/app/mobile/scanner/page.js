...
exports.default = QRScannerPage;
const react_1 = require("react");
const lucide_react_1 = require("lucide-react");
const navigation_1 = require("next/navigation");
function QRScannerPage() {
    const [scanning, setScanning] = (0, react_1.useState)(false);
    const [scannedData, setScannedData] = (0, react_1.useState)(null);
    const [error, setError] = (0, react_1.useState)(null);
    const [cameraPermission, setCameraPermission] = (0, react_1.useState)("prompt");
    const [bundleInfo, setBundleInfo] = (0, react_1.useState)(null);
    const videoRef = (0, react_1.useRef)(null);
    const canvasRef = (0, react_1.useRef)(null);
    const streamRef = (0, react_1.useRef)(null);
    const scanIntervalRef = (0, react_1.useRef)(null);
    ...
    return (<div className="min-h-screen bg-gray-900 text-white">
      ...
      <div className="border-b border-gray-700 bg-gray-800 p-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            <lucide_react_1.QrCode className="h-6 w-6 text-blue-400"/>
      ...
      <div className="p-4">
        ...
        {cameraPermission === "denied" && (<div className="mb-4 rounded-lg border border-red-700 bg-red-900 p-4">
            <div className="flex items-start space-x-3">
              <lucide_react_1.Info className="mt-0.5 h-5 w-5 flex-shrink-0 text-red-400"/>
              <div>
        ...
        {/* Scanner View */}
        {!scannedData && (<div className="space-y-4">
            <div className="relative overflow-hidden rounded-lg border-2 border-gray-700 bg-gray-800">
              {/* Video Preview */}
              <video ref={videoRef} className="h-auto w-full" playsInline muted style={{ maxHeight: "60vh" }}/>
              ...
              {/* No Camera Active */}
              {!scanning && (<div className="absolute inset-0 flex items-center justify-center bg-gray-900 bg-opacity-90">
                  <div className="text-center">
                    <lucide_react_1.Camera className="mx-auto mb-4 h-24 w-24 text-gray-600"/>
            ...
            {/* Scan Button */}
            {!scanning ? (<button onClick={startScanning} className="flex w-full items-center justify-center space-x-2 rounded-lg bg-blue-600 px-6 py-4 font-medium text-white transition-colors hover:bg-blue-700">
                <lucide_react_1.Camera className="h-5 w-5"/>
                <span>Start Scanning</span>
              </button>) : (<button onClick={stopScanning} className="flex w-full items-center justify-center space-x-2 rounded-lg bg-red-600 px-6 py-4 font-medium text-white transition-colors hover:bg-red-700">
        ...
        {/* Scanned Result */}
        {scannedData && bundleInfo && (<div className="space-y-4">
            {/* Success Icon */}
            ...
            <div className="overflow-hidden rounded-lg border border-gray-700 bg-gray-800">
              ...
              <div className="space-y-3 p-4">
                ...
                <div className="flex justify-between">
                  ...
                  <span className={`rounded-full px-2 py-1 text-xs font-medium ${bundleInfo.status === "COMPLETED"
            ...
            <div className="rounded-lg border border-gray-700 bg-gray-800 p-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <button onClick={() => updateBundleStatus("IN_PROGRESS")} className="rounded-lg bg-blue-600 px-4 py-3 font-medium transition-colors hover:bg-blue-700">
                  Start Work
                </button>
                <button onClick={() => updateBundleStatus("COMPLETED")} className="rounded-lg bg-green-600 px-4 py-3 font-medium transition-colors hover:bg-green-700">
                  Complete
                </button>
                <button onClick={() => updateBundleStatus("ON_HOLD")} className="rounded-lg bg-yellow-600 px-4 py-3 font-medium transition-colors hover:bg-yellow-700">
                  Hold
                </button>
                <button onClick={() => updateBundleStatus("DEFECT")} className="rounded-lg bg-red-600 px-4 py-3 font-medium transition-colors hover:bg-red-700">
                  Report Issue
                </button>
              </div>
            </div>
            ...
            {/* Scan Another Button */}
            <button onClick={resetScanner} className="flex w-full items-center justify-center space-x-2 rounded-lg bg-gray-700 px-6 py-4 font-medium text-white transition-colors hover:bg-gray-600">
        ...
        {/* Error Display */}
        {error && !bundleInfo && scannedData && (<div className="space-y-4">
