...
function OrderDetailPage() {
    ...
    if (error || !order) {
        ...
        <div className="text-center">
          ...
          <button onClick={() => router.push("/orders")} className="rounded-lg bg-blue-600 px-4 py-2 text-white hover:bg-blue-700">
            Back to Orders
          </button>
        </div>
      </div>);
    ...
    return (<div className="min-h-screen bg-gray-50 p-6">
      <div className="mx-auto max-w-7xl">
        {/* Header */}
        <div className="mb-6">
          <button onClick={() => router.push("/orders")} className="mb-4 flex items-center gap-2 text-gray-600 hover:text-gray-900">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-3">
              <button onClick={() => router.push(`/orders/${order.id}/edit`)} className="flex items-center gap-2 rounded-lg border border-gray-300 px-4 py-2 hover:bg-gray-50">
        ...
        {/* Status Badge */}
        <div className="mb-6">
          <span className={`inline-flex items-center rounded-full px-4 py-2 text-sm font-semibold ${getStatusColor(order.status)}`}>
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
          ...
          <div className="space-y-6 lg:col-span-2">
            ...
            <div className="rounded-lg bg-white p-6 shadow">
              ...
              {order.notes && (<div className="mt-4 border-t border-gray-200 pt-4">
            ...
            {/* Line Items */}
            {order.line_items.length > 0 && (<div className="rounded-lg bg-white p-6 shadow">
                <h2 className="mb-4 text-xl font-semibold text-gray-900">
                  Line Items
                </h2>
                <div className="overflow-x-auto">
                  <table className="w-full">
                    ...
                    <tbody className="divide-y divide-gray-200">
                      {order.line_items.map(item => (<tr key={item.id}>
          ...
          <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  <div className="rounded-lg bg-blue-100 p-2">
                    <lucide_react_1.DollarSign size={20} className="text-blue-600"/>
                  </div>
                  <div>
                ...
                <div className="flex items-center gap-3">
                  <div className="rounded-lg bg-purple-100 p-2">
                    <lucide_react_1.FileText size={20} className="text-purple-600"/>
                  </div>
                  <div>
                ...
                <div className="flex items-center gap-3">
                  <div className="rounded-lg bg-yellow-100 p-2">
                    <lucide_react_1.Calendar size={20} className="text-yellow-600"/>
                  </div>
                  <div>
            ...
            <div className="rounded-lg bg-white p-6 shadow">
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  <div className="rounded-lg bg-blue-100 p-2">
                    <lucide_react_1.User size={20} className="text-blue-600"/>
                  </div>
                  <div>
                ...
                {order.client.phone && (<div className="pl-11">
            ...
            {/* Brand Information */}
            {order.brand && (<div className="rounded-lg bg-white p-6 shadow">
                <h2 className="mb-4 text-xl font-semibold text-gray-900">
                  Brand Information
                </h2>
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    <div className="rounded-lg bg-purple-100 p-2">
                      <lucide_react_1.Building size={20} className="text-purple-600"/>
                    </div>
                    <div>
