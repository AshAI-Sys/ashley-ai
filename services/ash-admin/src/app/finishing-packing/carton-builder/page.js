            ...
            <card_1.Card>
              ...
              <card_1.CardContent>
                <div className="max-h-96 space-y-3 overflow-y-auto">
                  {availableUnits.map(unit => (<div key={unit.id} className="rounded-lg border p-3 hover:bg-gray-50">
                ...
                {availableUnits.length === 0 && (<div className="py-8 text-center text-gray-500">
                    <lucide_react_1.Package className="mx-auto mb-2 h-8 w-8"/>
                ...
                <card_1.CardHeader>
                  <card_1.CardTitle className="flex items-center justify-between">
                    <span className="flex items-center">
                      <lucide_react_1.Box className="mr-2 h-5 w-5"/>
                      Carton Configuration
                    </span>
              ...
              <card_1.Card>
                ...
                <card_1.CardContent>
                  {cartonState.contents.length > 0 ? (<div className="space-y-3">
                      {cartonState.contents.map((content, index) => (<div key={index} className="flex items-center justify-between rounded-lg border p-3">
                          <div>
                      ...
                      <lucide_react_1.Box className="mx-auto mb-4 h-12 w-12 text-gray-500"/>
