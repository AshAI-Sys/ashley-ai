          ...
          <table className="min-w-full divide-y divide-gray-200">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {(Array.isArray(runs) ? runs : []).map((run) => (<tr key={run.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm text-gray-900">
                      {(Array.isArray(run.materials_used) ? run.materials_used : []).map((material, index) => (<div key={index} className="text-xs text-gray-600">
                    ...
                    <div>
                      ...
                      <div className="flex items-center mt-1">
                        ...
                        <div className="w-16 bg-gray-200 rounded-full h-2">
                          <div className={`h-2 rounded-full ${(carton.fill_percent || 0) >= 90 ? 'bg-green-600' :
                (carton.fill_percent || 0) >= 70 ? 'bg-yellow-600' : 'bg-red-600'}`} style={{ width: `${carton.fill_percent || 0}%` }}></div>
                        </div>
                      </div>
                    </div>
                  </td>
