...
function LoginPage() {
    const [email, setEmail] = (0, react_1.useState)('admin@ash.com');
      ...
      <div style={{
        ...
        <form onSubmit={handleSubmit} style={{ marginBottom: '24px' }}>
          <div style={{ marginBottom: '16px' }}>
            ...
            <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="admin@ash.com" required style={{
            width: '100%',
            padding: '12px 16px',
