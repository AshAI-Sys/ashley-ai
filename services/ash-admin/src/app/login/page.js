...
function LoginPage() {
    const [email, setEmail] = (0, react_1.useState)('admin@ashleyai.com');
    const [password, setPassword] = (0, react_1.useState)('admin123');
      ...
      <div style={{
        ...
        <form onSubmit={handleSubmit} style={{ marginBottom: '24px' }} method="POST" action="#">
          <div style={{ marginBottom: '16px' }}>
            ...
            <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="admin@ashleyai.com" required style={{
            width: '100%',
            padding: '12px 16px',
          ...
          <div style={{ marginBottom: '24px' }}>
            ...
            <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} placeholder="admin123" required style={{
            width: '100%',
            padding: '12px 16px',
            border: '1px solid #d1d5db',
            borderRadius: '8px',
          ...
          <button type="button" onClick={handleSubmit} disabled={isLoading} style={{
            width: '100%',
