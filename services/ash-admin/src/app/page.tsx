  ...
  return (
    ...
    >
      <div className="corporate-card max-w-lg p-12 text-center">
        ...
        <Link
          href="/login"
          className="inline-block w-full rounded-xl bg-corporate-blue px-6 py-4 text-base font-semibold text-white shadow-corporate transition-all hover:bg-blue-700 hover:shadow-corporate-hover"
        >
