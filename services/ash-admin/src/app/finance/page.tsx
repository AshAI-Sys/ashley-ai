...
export default function FinancePage() {
  ...
  const {
    ...
    queryFn: async () => {
      ...
      if (!data.success)
        throw new Error(data.error || "Failed to fetch finance metrics");
  ...
  const {
    ...
    queryFn: async () => {
      ...
      return (data.data || []).map((bill: any) => {
        ...
        const daysUntilDue =
          bill.status !== "PAID" && dueDate > today
            ? Math.ceil(
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <p className="text-sm text-gray-600 lg:text-base">
              Manage invoices, payments, bills, and financial reporting
            </p>
          </div>
            ...
            <>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-gray-900">
                        {formatCurrency(metrics?.ytd_revenue || 0)}
                      </p>
                    </div>
                    ...
                    {(metrics?.revenue_growth || 0) >= 0 ? (
                      <>
                        ...
                        <span className="text-sm text-green-600">
                          +{metrics?.revenue_growth?.toFixed(1) || 0}% from last
                          month
                        </span>
                      </>
                    ) : (
                ...
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-gray-900">
                        {formatCurrency(metrics?.outstanding_invoices || 0)}
                      </p>
                    </div>
                  ...
                  <div className="mt-2 flex items-center">
                    ...
                    <span className="text-sm text-red-600">
                      {formatCurrency(metrics?.overdue_invoices || 0)} overdue
                    </span>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="mb-1 text-sm text-gray-600">Gross Margin</p>
                      <p className="text-2xl font-bold text-gray-900">
                  ...
                  <div className="mt-2 flex items-center">
                    <span className="text-sm text-gray-600">
                      COGS: {formatCurrency(metrics?.total_cogs || 0)}
                    </span>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-gray-900">
                        {formatCurrency(metrics?.pending_bills || 0)}
                      </p>
                    </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex gap-4">
                    <select
                      ...
                      className="min-w-[140px] rounded-md border border-gray-300 px-3 py-2 text-sm"
                    >
                          ...
                          <div className="min-w-0 flex-1">
                            ...
                            <div className="mb-3 flex flex-col gap-2 sm:flex-row sm:items-center sm:gap-3">
                              ...
                              {invoice.days_overdue && (
                                <Badge className="w-fit bg-red-100 text-red-800">
                            ...
                            <div className="xs:grid-cols-2 grid grid-cols-1 gap-3 text-sm lg:grid-cols-4">
                              ...
                              <div className="flex flex-col">
                                ...
                                <span className="mt-0.5 font-medium text-red-600">
                            ...
                            <div className="mt-3 flex flex-wrap gap-x-4 gap-y-1 text-xs text-gray-500">
                              <span>
                                Issued: {formatDate(invoice.date_issued)}
                              </span>
                      ...
                      >
                        <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                          <div className="min-w-0 flex-1">
                            ...
                            {/* Details Grid - Optimized for mobile */}
                            <div className="xs:grid-cols-2 grid grid-cols-1 gap-3 text-sm lg:grid-cols-3">
                              <div className="flex flex-col">
                                <span className="text-xs font-medium text-gray-500">
                                  Supplier
                                </span>
          ...
          <TabsContent value="costing" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Manufacturing costs and profitability by order/brand
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="py-12 text-center">
                  ...
                  <p className="mb-4 text-gray-600">
                    Cost analysis tools will be available here
                  </p>
                  <p className="text-sm text-gray-500">
                    Material costs, labor allocation, overhead distribution, and
                    P&L analysis
                  </p>
                </div>
              </CardContent>
          ...
          <TabsContent value="reports" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Export financial data and compliance reports
                </CardDescription>
              </CardHeader>
              <CardContent>
