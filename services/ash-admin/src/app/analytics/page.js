      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <select value={timeRange} onChange={(e) => setTimeRange(e.target.value)} className="px-3 py-2 border border-gray-300 rounded-md text-sm">
        ...
        {metrics && (<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <card_1.Card>
              <card_1.CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <card_1.CardTitle className="text-sm font-medium">Production Efficiency</card_1.CardTitle>
            ...
            <card_1.Card>
              <card_1.CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <card_1.CardTitle className="text-sm font-medium">Quality Score</card_1.CardTitle>
            ...
            <card_1.Card>
              <card_1.CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <card_1.CardTitle className="text-sm font-medium">On-Time Delivery</card_1.CardTitle>
            ...
            <card_1.Card>
              <card_1.CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <card_1.CardTitle className="text-sm font-medium">Revenue Growth</card_1.CardTitle>
        ...
        <tabs_1.Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              {metrics && (<card_1.Card>
                  <card_1.CardHeader>
                    ...
                    <card_1.CardDescription>Key business performance indicators</card_1.CardDescription>
                  </card_1.CardHeader>
                  <card_1.CardContent>
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-sm font-bold">{metrics.avg_cycle_time} days</span>
                      </div>
                      <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-sm font-bold">{metrics.orders_in_progress}</span>
                      </div>
                    </div>
                  </card_1.CardContent>
                </card_1.Card>)}
          ...
          <tabs_1.TabsContent value="production" className="space-y-4">
            {productionMetrics && (<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <card_1.Card>
                  <card_1.CardHeader className="pb-2">
                    <card_1.CardTitle className="text-sm font-medium">Cutting Efficiency</card_1.CardTitle>
                  </card_1.CardHeader>
                  <card_1.CardContent>
                ...
                <card_1.Card>
                  <card_1.CardHeader className="pb-2">
                    <card_1.CardTitle className="text-sm font-medium">Printing Efficiency</card_1.CardTitle>
                  </card_1.CardHeader>
                  <card_1.CardContent>
                ...
                <card_1.Card>
                  <card_1.CardHeader className="pb-2">
                    <card_1.CardTitle className="text-sm font-medium">Sewing Efficiency</card_1.CardTitle>
                  </card_1.CardHeader>
                  <card_1.CardContent>
                ...
                <card_1.Card>
                  <card_1.CardHeader className="pb-2">
                    <card_1.CardTitle className="text-sm font-medium">Overall Throughput</card_1.CardTitle>
                  </card_1.CardHeader>
                  <card_1.CardContent>
          ...
          <tabs_1.TabsContent value="financial" className="space-y-4">
            {financialMetrics && (<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <card_1.Card>
                  <card_1.CardHeader className="pb-2">
                ...
                <card_1.Card>
                  <card_1.CardHeader className="pb-2">
                    <card_1.CardTitle className="text-sm font-medium">Gross Margin</card_1.CardTitle>
                  </card_1.CardHeader>
                  <card_1.CardContent>
                ...
                <card_1.Card>
                  <card_1.CardHeader className="pb-2">
                    <card_1.CardTitle className="text-sm font-medium">Cost Per Unit</card_1.CardTitle>
                  </card_1.CardHeader>
                  <card_1.CardContent>
                ...
                <card_1.Card>
                  <card_1.CardHeader className="pb-2">
                    <card_1.CardTitle className="text-sm font-medium">Collection Rate</card_1.CardTitle>
                  </card_1.CardHeader>
                  <card_1.CardContent>
          ...
          <tabs_1.TabsContent value="operational" className="space-y-4">
            {operationalMetrics && (<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <card_1.Card>
                  <card_1.CardHeader className="pb-2">
                    <card_1.CardTitle className="text-sm font-medium">Machine Utilization</card_1.CardTitle>
                  </card_1.CardHeader>
                  <card_1.CardContent>
                ...
                <card_1.Card>
                  <card_1.CardHeader className="pb-2">
                    <card_1.CardTitle className="text-sm font-medium">Workforce Productivity</card_1.CardTitle>
                  </card_1.CardHeader>
                  <card_1.CardContent>
                ...
                <card_1.Card>
                  <card_1.CardHeader className="pb-2">
                    <card_1.CardTitle className="text-sm font-medium">Safety Incidents</card_1.CardTitle>
                  </card_1.CardHeader>
                  <card_1.CardContent>
                ...
                <card_1.Card>
                  <card_1.CardHeader className="pb-2">
                    <card_1.CardTitle className="text-sm font-medium">Training Completion</card_1.CardTitle>
                  </card_1.CardHeader>
                  <card_1.CardContent>
          ...
          <tabs_1.TabsContent value="quality" className="space-y-4">
            {productionMetrics && (<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <card_1.Card>
                  <card_1.CardHeader>
                    <card_1.CardTitle className="flex items-center gap-2">
                  ...
                  <card_1.CardContent>
                    ...
                    <p className="text-sm text-gray-600 mt-2">Quality control performance</p>
                  </card_1.CardContent>
                </card_1.Card>
                ...
                <card_1.Card>
                  ...
                  <card_1.CardContent>
                    ...
                    <p className="text-sm text-gray-600 mt-2">Production defects</p>
                  </card_1.CardContent>
                </card_1.Card>
                ...
                <card_1.Card>
                  ...
                  <card_1.CardContent>
                    ...
                    <p className="text-sm text-gray-600 mt-2">Items requiring rework</p>
                  </card_1.CardContent>
                </card_1.Card>
              </div>)}
          </tabs_1.TabsContent>
