...
export default function Analytics() {
  ...
  const getScoreBadge = (score: number, threshold: { good: number; warning: number }) => {
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        ...
                        <Badge className={getScoreBadge(metrics.customer_satisfaction, { good: 90, warning: 80 })}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <Card>
                  <CardHeader className="pb-2">
                    <CardTitle className="text-sm font-medium">Cutting Efficiency</CardTitle>
                  </CardHeader>
                  <CardContent>
                ...
                <Card>
                  <CardHeader className="pb-2">
                    <CardTitle className="text-sm font-medium">Printing Efficiency</CardTitle>
                  </CardHeader>
                  <CardContent>
                ...
                <Card>
                  <CardHeader className="pb-2">
                    <CardTitle className="text-sm font-medium">Overall Throughput</CardTitle>
                  </CardHeader>
                  <CardContent>
          ...
          <TabsContent value="operational" className="space-y-4">
            {operationalMetrics && (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <Card>
                  <CardHeader className="pb-2">
                    <CardTitle className="text-sm font-medium">Workforce Productivity</CardTitle>
                  </CardHeader>
                  <CardContent>
