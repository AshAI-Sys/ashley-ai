    ...
    return (<div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-6 py-8">
        ...
        {isCompleted && (<card_1.Card className="mb-6 border-green-200 bg-green-50">
            <card_1.CardContent className="py-4">
              <div className="flex items-center gap-3">
                {approvalData.status === "APPROVED" ? (<lucide_react_1.CheckCircle className="h-5 w-5 text-green-600"/>) : (<lucide_react_1.MessageCircle className="h-5 w-5 text-yellow-600"/>)}
                <div>
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          ...
          <div className="space-y-6 lg:col-span-2">
            ...
            <card_1.Card>
              ...
              <card_1.CardContent>
                {files.mockup_url && !imageError ? (<div className="text-center">
                    <img src={files.mockup_url} alt="Design mockup" className="mx-auto h-auto max-w-full rounded-lg shadow-lg transition-transform duration-200" style={{
              ...
              {placements.length > 0 && (<card_1.Card>
                  ...
                  <card_1.CardContent>
                    <div className="space-y-3">
                      {placements.map((placement, index) => (<div key={index} className="rounded-lg bg-gray-50 p-3">
                  ...
                  <card_1.CardContent>
                    <div className="grid grid-cols-2 gap-3">
                      {palette.map((color, index) => (<div key={index} className="flex items-center gap-2">
                          <div className="h-8 w-8 flex-shrink-0 rounded border border-gray-300" style={{ backgroundColor: color }}/>
            ...
            {!isCompleted && !isExpired && (<card_1.Card>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex gap-3">
                      <button_1.Button size="lg" variant={decision === "approved" ? "default" : "outline"} className={`flex-1 ${decision === "approved" ? "bg-green-600 hover:bg-green-700" : ""}`} onClick={() => setDecision("approved")}>
                        <lucide_react_1.ThumbsUp className="mr-2 h-5 w-5"/>
                        Approve Design
                      </button_1.Button>
                      <button_1.Button size="lg" variant={decision === "changes_requested"
                ? "default"
                : "outline"} className={`flex-1 ${decision === "changes_requested" ? "bg-yellow-600 hover:bg-yellow-700" : ""}`} onClick={() => setDecision("changes_requested")}>
                        <lucide_react_1.ThumbsDown className="mr-2 h-5 w-5"/>
                        Request Changes
                      </button_1.Button>
                    </div>
                  </div>
                ...
                : "Any additional comments or notes..."} rows={4} className={decision === "changes_requested"
                ? "border-yellow-300"
                : ""}/>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      ...
                      {attachments.length > 0 && (<div className="space-y-2">
                          {attachments.map((file, index) => (<div key={index} className="flex items-center justify-between rounded bg-gray-50 p-2">
                              <div className="flex items-center gap-2">
                                <lucide_react_1.FileText className="h-4 w-4 text-gray-500"/>
                  ...
                  {/* Submit Button */}
                  <button_1.Button size="lg" onClick={handleSubmitDecision} disabled={submitting ||
                !decision ||
                !approverName.trim() ||
                (decision === "changes_requested" && !feedback.trim())} className="w-full">
              ...
              <card_1.CardContent className="text-sm">
                <ul className="space-y-2">
                  <li className="flex items-start gap-2">
                    <lucide_react_1.CheckCircle className="mt-0.5 h-4 w-4 flex-shrink-0 text-green-500"/>
