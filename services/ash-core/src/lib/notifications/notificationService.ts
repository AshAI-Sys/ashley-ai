...
export class NotificationService {
  ...
  async handleApprovalNotification(data: ApprovalNotificationData) {
    try {
  ...
  private async handleApprovalSent(approval: any, data: ApprovalNotificationData) {
  ...
  private async handleApprovalApproved(approval: any, data: ApprovalNotificationData) {
  ...
  private async handleChangesRequested(approval: any, data: ApprovalNotificationData) {
    // Create internal notification for team
    await this.createNotification({
      workspace_id: approval.workspace_id,
  ...
  private async handleApprovalExpired(approval: any, data: ApprovalNotificationData) {
    // Create internal notification
    await this.createNotification({
      workspace_id: approval.workspace_id,
  ...
  private async handleApprovalReminded(approval: any, data: ApprovalNotificationData) {
    // Create internal notification
    await this.createNotification({
      workspace_id: approval.workspace_id,
  ...
  async sendBatchNotifications(approvals: any[], action: string, message?: string) {
