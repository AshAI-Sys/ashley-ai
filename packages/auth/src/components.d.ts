...
export declare function AuthGuard({ children, fallback, loading, requireAuth }: AuthGuardProps): React.JSX.Element;
export declare function RoleGuard({ children, roles, requireAll, fallback, loading }: RoleGuardProps): React.JSX.Element;
export declare function PermissionGuard({ children, permissions, requireAll, fallback, loading }: PermissionGuardProps): React.JSX.Element;
export declare function AdminGuard({ children, fallback, loading }: ProtectedProps): React.JSX.Element;
export declare function ManagerGuard({ children, fallback, loading }: ProtectedProps): React.JSX.Element;
