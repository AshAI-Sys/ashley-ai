...
export declare function hasAnyPermission(
  userRole: UserRole,
  permissions: Permission[]
): boolean;
export declare function hasAllPermissions(
  userRole: UserRole,
  permissions: Permission[]
): boolean;
...
export declare function createRateLimitKey(
  identifier: string,
  action: string
): string;
export declare function isRateLimited(
  attempts: number,
  timeWindow: number,
  maxAttempts: number
): boolean;
