...
class MaterialRequirementPlanner {
  ...
  async projectStockLevels(materialId) {
    ...
    for (
      ...
      const dayDemands = demands.filter(
        d => (0, date_fns_1.format)(d.requiredDate, "yyyy-MM-dd") === dateStr
      );
      const daySupplies = supplies.filter(
        s => (0, date_fns_1.format)(s.plannedDate, "yyyy-MM-dd") === dateStr
      );
  ...
  async getMaterialDemands(orderId) {
    ...
    return requirements.map(req => ({
      ...
      requiredDate:
        req.order.delivery_date || (0, date_fns_1.addDays)(new Date(), 30),
