import type { ProductionCapacity, WorkerCapacity, ShiftType, SkillLevel, ProductionMetrics } from "./types";
...
export declare class ProductionScheduler {
    ...
    assignWorkerToTask(request: WorkerAssignmentRequest): Promise<WorkerAssignmentResult>;
    optimizeProductionSchedule(scheduleIds: string[], optimizationGoals?: {
        minimizeTime?: boolean;
        minimizeCost?: boolean;
        maximizeQuality?: boolean;
        balanceWorkload?: boolean;
    }): Promise<ProductionScheduleOptimization>;
    calculateProductionCapacity(productionLineId: string, date: Date, shift: ShiftType): Promise<ProductionCapacity>;
    getWorkerCapacity(workerId: string, date: Date, shift: ShiftType): Promise<WorkerCapacity>;
    generateProductionMetrics(date: Date, productionLineId?: string, workerId?: string): Promise<ProductionMetrics>;
