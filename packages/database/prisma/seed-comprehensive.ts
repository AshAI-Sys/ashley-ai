...
async function main() {
  ...
  console.log(
    `✅ Created ${clients.length} clients and ${brands.length} brands\n`
  );
  ...
  console.log(
    `✅ Created ${fabricBatches.length} fabric batches, ${cutLays.length} cut lays, ${bundles.length} bundles\n`
  );
  ...
  console.log(
    `✅ Created ${machines.length} machines, ${printRuns.length} print runs\n`
  );
  ...
  console.log(
    `✅ Created ${sewingOps.length} sewing operations, ${sewingRuns.length} sewing runs\n`
  );
  ...
  console.log(
    `✅ Created ${defectCodes.length} defect codes, ${qcInspections.length} QC inspections\n`
  );
  ...
  console.log(
    `✅ Created ${invoices.length} invoices, ${payments.length} payments, ${expenses.length} expenses\n`
  );
  ...
  console.log(
    `✅ Created ${assets.length} assets, ${workOrders.length} work orders\n`
  );
