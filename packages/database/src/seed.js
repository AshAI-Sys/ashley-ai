...
async function main() {
    ...
    const workspace = await index_1.prisma.workspace.upsert({
    ...
    // Create manager user
    const managerUser = await index_1.prisma.user.upsert({
        where: {
            workspace_id_email: {
                workspace_id: workspace.id,
    ...
    // Create demo clients
    const client1 = await index_1.prisma.client.create({
        data: {
            id: (0, uuid_1.v4)(),
            workspace_id: workspace.id,
    ...
    const client2 = await index_1.prisma.client.create({
        data: {
            id: (0, uuid_1.v4)(),
            workspace_id: workspace.id,
            name: "Urban Style PH",
    ...
    const brand1 = await index_1.prisma.brand.create({
        data: {
            id: (0, uuid_1.v4)(),
            workspace_id: workspace.id,
    ...
    const brand2 = await index_1.prisma.brand.create({
        data: {
            id: (0, uuid_1.v4)(),
            workspace_id: workspace.id,
            client_id: client1.id,
    ...
    const brand3 = await index_1.prisma.brand.create({
        data: {
            id: (0, uuid_1.v4)(),
            workspace_id: workspace.id,
    ...
    const order1 = await index_1.prisma.order.create({
        data: {
            id: (0, uuid_1.v4)(),
            workspace_id: workspace.id,
            client_id: client1.id,
    ...
    await index_1.prisma.orderLineItem.createMany({
        data: [
            {
                id: (0, uuid_1.v4)(),
                workspace_id: workspace.id,
    ...
    const order2 = await index_1.prisma.order.create({
        data: {
            id: (0, uuid_1.v4)(),
            workspace_id: workspace.id,
            client_id: client2.id,
    ...
    const designAsset1 = await index_1.prisma.designAsset.create({
        data: {
            id: (0, uuid_1.v4)(),
            workspace_id: workspace.id,
            brand_id: brand1.id,
    ...
    const designAsset2 = await index_1.prisma.designAsset.create({
        data: {
            id: (0, uuid_1.v4)(),
            workspace_id: workspace.id,
            brand_id: brand3.id,
    ...
    await index_1.prisma.designVersion.createMany({
        data: [
            {
                id: (0, uuid_1.v4)(),
    ...
    await index_1.prisma.designApproval.createMany({
        data: [
            {
                id: (0, uuid_1.v4)(),
                workspace_id: workspace.id,
    ...
    await index_1.prisma.designCheck.createMany({
        data: [
            {
                id: (0, uuid_1.v4)(),
                asset_id: designAsset1.id,
    ...
    // Create employees
    const employees = await index_1.prisma.employee.createMany({
        data: [
            {
                id: (0, uuid_1.v4)(),
                workspace_id: workspace.id,
                ...
                password_hash: "$2a$10$dummyHashForSeedDataOnly123456789012345678901234",
            ...
            },
            {
                ...
                first_name: "Maria",
                last_name: "Garcia",
                email: "maria.garcia@ashleyai.com",
                password_hash: "$2a$10$dummyHashForSeedDataOnly123456789012345678901234",
            ...
            },
            {
                ...
                first_name: "Roberto",
                last_name: "Reyes",
                email: "roberto.reyes@ashleyai.com",
                password_hash: "$2a$10$dummyHashForSeedDataOnly123456789012345678901234",
            ...
            },
            {
                ...
                email: "ana.villanueva@ashleyai.com",
                password_hash: "$2a$10$dummyHashForSeedDataOnly123456789012345678901234",
    ...
    const assets = await index_1.prisma.asset.createMany({
        data: [
            {
                id: (0, uuid_1.v4)(),
                workspace_id: workspace.id,
    ...
    const silkscreenTemplate = await index_1.prisma.routingTemplate.create({
        data: {
            id: (0, uuid_1.v4)(),
            workspace_id: workspace.id,
    ...
    await index_1.prisma.routingTemplateStep.createMany({
        data: [
            {
                id: (0, uuid_1.v4)(),
                workspace_id: workspace.id,
    ...
    const fabricBatch1 = await index_1.prisma.fabricBatch.create({
        data: {
            id: (0, uuid_1.v4)(),
            workspace_id: workspace.id,
            brand_id: brand1.id,
    ...
    const fabricBatch2 = await index_1.prisma.fabricBatch.create({
        data: {
            id: (0, uuid_1.v4)(),
            workspace_id: workspace.id,
            brand_id: brand3.id,
    ...
    // Create cut issues
    const cutIssue1 = await index_1.prisma.cutIssue.create({
        data: {
            id: (0, uuid_1.v4)(),
            workspace_id: workspace.id,
            order_id: order1.id,
    ...
    // Create cut lay
    const cutLay1 = await index_1.prisma.cutLay.create({
        data: {
            id: (0, uuid_1.v4)(),
            workspace_id: workspace.id,
            order_id: order1.id,
    ...
    await index_1.prisma.cutOutput.createMany({
        data: [
            {
                id: (0, uuid_1.v4)(),
                workspace_id: workspace.id,
    ...
    const bundles = await index_1.prisma.bundle.createMany({
        data: [
            {
                id: (0, uuid_1.v4)(),
                workspace_id: workspace.id,
