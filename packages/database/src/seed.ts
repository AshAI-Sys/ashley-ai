...
async function main() {
  ...
  console.log(
    `✅ Created demo brands: ${brand1.name}, ${brand2.name}, ${brand3.name}`
  );
  ...
  console.log(
    `✅ Created demo orders: ${order1.order_number}, ${order2.order_number}`
  );
    ...
    data: [
      ...
      },
      {
        ...
        meta: JSON.stringify({
          dpi: 300,
          notes:
            "Revised version with client feedback - larger size and cleaner separations",
        }),
        created_by: adminUser.id,
      },
      {
    ...
    data: [
      {
        ...
        comments:
          "Please make the logo 20% larger and adjust the color intensity",
        portal_token:
          "sample_token_1_" +
  ...
  console.log(
    `✅ Created demo design assets: ${designAsset1.name}, ${designAsset2.name}`
  );
    ...
    data: [
      {
        ...
        password_hash:
          "$2a$10$dummyHashForSeedDataOnly123456789012345678901234",
  ...
  console.log(
    `✅ Created fabric batches: ${fabricBatch1.lot_no}, ${fabricBatch2.lot_no}`
  );
