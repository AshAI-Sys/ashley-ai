...
export declare class DesignCollaborationSystem extends EventEmitter {
    ...
    addComment(data: z.infer<typeof CreateCommentSchema>, authorId: string): Promise<{
        id: string;
        workspace_id: string;
        created_at: Date;
        updated_at: Date;
    ...
    resolveComment(commentId: string, resolverId: string, resolution?: string): Promise<{
        id: string;
        workspace_id: string;
        created_at: Date;
        updated_at: Date;
    ...
    getDesignCollaborators(designAssetId: string, versionId?: string): Promise<{
        id: string;
        workspace_id: string;
        is_active: boolean;
        design_asset_id: string;
    ...
    getDesignComments(designAssetId: string, versionId?: string): Promise<{
        id: string;
        workspace_id: string;
        created_at: Date;
        updated_at: Date;
    ...
    updateCollaboratorPermission(collaborationId: string, newPermissionLevel: PermissionLevel, updatedBy: string): Promise<{
        id: string;
        workspace_id: string;
        is_active: boolean;
        design_asset_id: string;
    ...
    removeCollaborator(collaborationId: string, removedBy: string): Promise<{
        id: string;
        workspace_id: string;
        is_active: boolean;
        design_asset_id: string;
