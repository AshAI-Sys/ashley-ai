...
import type { QCInspection, QCCriteriaResult, QCDefect, QCStage } from "./types";
...
export declare class QualityInspectionSystem extends EventEmitter {
    ...
    completeInspection(inspectionId: string, results: {
    ...
    getQualityTrends(startDate: Date, endDate: Date, filters?: {
