...
export const CapacityOverview = React.forwardRef<
  HTMLDivElement,
...
>(
  (
    ...
    const criticalLines = productionLines.filter(
      line => line.status === "OVERLOADED" || line.bottleneckRisk === "HIGH"
    ).length;

    const getEfficiencyTrend = (efficiency: number) => {
      if (efficiency > 85)
        return <TrendingUp className="text-ash-green-600 h-4 w-4" />;
      if (efficiency < 70)
        return <TrendingDown className="h-4 w-4 text-red-600" />;
      return <Clock className="text-ash-orange-600 h-4 w-4" />;
    };
                      ...
                      <div className="grid grid-cols-2 gap-4 text-sm md:grid-cols-4">
                        ...
                        <div>
                          ...
                          <div
                            className={cn(
                              "text-xs font-medium",
                              bottleneckColors[line.bottleneckRisk]
                            )}
                          >
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
              ...
              <div>
                ...
                <div>
                  ...
                  <Progress
                    value={workerSummary.avgEfficiency}
                    className="mt-2"
                  />
                </div>
              </div>
