...
const clientFormSchema = zod_2.z.object({
    ...
    paymentTerms: zod_2.z.number().min(0).max(90, "Payment terms must be between 0-90 days"),
            ...
            <card_1.Card>
              ...
              <card_1.CardContent className="space-y-6">
                ...
                <form_1.FormField control={form.control} name="notes" render={({ field }) => (<form_1.FormItem>
                      ...
                      <form_1.FormControl>
                        <textarea {...field} className="min-h-[100px] w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50" placeholder="Any special requirements, preferences, or important information about this client..."/>
                      </form_1.FormControl>
                      <form_1.FormMessage />
                    </form_1.FormItem>)}/>
              </card_1.CardContent>
