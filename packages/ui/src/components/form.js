...
const FormLabel = React.forwardRef(({ className, ...props }, ref) => {
    ...
    return (<LabelPrimitive.Root ref={ref} className={(0, utils_1.cn)("text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70", error && "text-destructive", className)} htmlFor={formItemId} {...props}/>);
});
