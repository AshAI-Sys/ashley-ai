...
const FormLabel = React.forwardRef(({ className, ...props }, ref) => {
    ...
    return (<LabelPrimitive.Root ref={ref} className={(0, utils_1.cn)("text-sm leading-none font-medium peer-disabled:cursor-not-allowed peer-disabled:opacity-70", error && "text-destructive", className)} htmlFor={formItemId} {...props}/>);
});
...
const FormDescription = React.forwardRef(({ className, ...props }, ref) => {
    ...
    return (<p ref={ref} id={formDescriptionId} className={(0, utils_1.cn)("text-muted-foreground text-sm", className)} {...props}/>);
});
...
const FormMessage = React.forwardRef(({ className, children, ...props }, ref) => {
    ...
    return (<p ref={ref} id={formMessageId} className={(0, utils_1.cn)("text-destructive text-sm font-medium", className)} {...props}>
      {body}
    </p>);
});
