...
const Card = React.forwardRef(({ className, ...props }, ref) => (<div ref={ref} className={(0, utils_1.cn)("bg-card text-card-foreground rounded-lg border shadow-sm", className)} {...props}/>));
exports.Card = Card;
...
const CardTitle = React.forwardRef(({ className, ...props }, ref) => (<h3 ref={ref} className={(0, utils_1.cn)("text-2xl leading-none font-semibold tracking-tight", className)} {...props}/>));
