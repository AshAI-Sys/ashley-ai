...
const badgeVariants = (0, class_variance_authority_1.cva)("inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2", {
    variants: {
        variant: {
            ...
            success: "border-transparent bg-ash-green-100 text-ash-green-800 hover:bg-ash-green-200",
            warning: "border-transparent bg-ash-orange-100 text-ash-orange-800 hover:bg-ash-orange-200",
            info: "border-transparent bg-ash-blue-100 text-ash-blue-800 hover:bg-ash-blue-200",
        },
    },
    defaultVariants: {
        variant: "default",
