...
describe("Ashley AI API Integration Tests", () => {
  ...
  describe("Finance API", () => {
    it("should create invoice successfully", async () => {
      ...
      expect(mockInvoice.subtotal).toBe(250.0);
    ...
    it("should process payment correctly", async () => {
      ...
      expect(mockPayment.amount).toBe(250.0);
    });
  });
  ...
  describe("Quality Control API", () => {
    ...
    it("should calculate pass/fail based on AQL", async () => {
      ...
      const passFail =
        inspectionResult.defects_found <= inspectionResult.acceptance_number
          ? "PASS"
          : "FAIL";
  ...
  describe("Production API", () => {
    ...
    it("should track production efficiency", async () => {
      ...
      const efficiency =
        (productionData.completed_pieces / productionData.target_pieces) *
        (productionData.target_time / productionData.actual_time) *
        100;
