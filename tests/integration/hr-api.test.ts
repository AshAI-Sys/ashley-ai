...
describe('HR API Integration Tests', () => {
  ...
  describe('GET /api/hr/employees', () => {
    ...
    it('should filter employees by status', async () => {
      ...
      const response = await fetch(`${API_BASE}/api/hr/employees?is_active=true`, {
        headers: {
          'Authorization': `Bearer ${authToken}`,
          'Content-Type': 'application/json',
        },
    ...
    it('should filter employees by department', async () => {
      ...
      const response = await fetch(`${API_BASE}/api/hr/employees?department=Production`, {
        headers: {
          'Authorization': `Bearer ${authToken}`,
          'Content-Type': 'application/json',
        },
    ...
    it('should filter employees by position', async () => {
      ...
      const response = await fetch(`${API_BASE}/api/hr/employees?position=Sewing Operator`, {
        headers: {
          'Authorization': `Bearer ${authToken}`,
          'Content-Type': 'application/json',
        },
  ...
  describe('POST /api/hr/employees', () => {
    ...
    it('should validate salary type and rate', async () => {
      if (!authToken) {
        console.log('⏭️  Skipping: No auth token')
        return
      }
  ...
  describe('GET /api/hr/attendance', () => {
    ...
    it('should filter attendance by date', async () => {
      ...
      const response = await fetch(`${API_BASE}/api/hr/attendance?date=${today}`, {
        headers: {
          'Authorization': `Bearer ${authToken}`,
          'Content-Type': 'application/json',
        },
    ...
    it('should filter attendance by employee', async () => {
      ...
      const response = await fetch(`${API_BASE}/api/hr/attendance?employee_id=${employeeId}`, {
        headers: {
          'Authorization': `Bearer ${authToken}`,
          'Content-Type': 'application/json',
        },
  ...
  describe('POST /api/hr/attendance', () => {
    ...
    it('should calculate hours correctly', async () => {
      ...
      if (response.status === 200 || response.status === 201) {
        ...
        const totalHours = (record.regular_hours || 0) + (record.overtime_hours || 0)
  ...
  describe('GET /api/hr/stats', () => {
    ...
    it('should include employee count metrics', async () => {
      if (!authToken) {
        console.log('⏭️  Skipping: No auth token')
        return
      }
  ...
  describe('GET /api/hr/payroll', () => {
    ...
    it('should filter payroll by period', async () => {
      if (!authToken) {
        console.log('⏭️  Skipping: No auth token')
        return
      }
  ...
  describe('Performance', () => {
    it('should return employees list within 2 seconds', async () => {
      if (!authToken) {
        console.log('⏭️  Skipping: No auth token')
        return
      }
