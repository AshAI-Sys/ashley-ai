...
async function seedEmployees() {
  ...
  try {
    ...
    for (const emp of employees) {
      ...
      console.log(
        `✅ Created employee: ${employee.first_name} ${employee.last_name} (${employee.email})`
      );
    }
    ...
    console.log(
      "Email: cutting@ashleyai.com | Password: password | Role: Cutting Operator"
    );
    console.log(
      "Email: sewing@ashleyai.com | Password: password | Role: Sewing Operator"
    );
    console.log(
      "Email: qc@ashleyai.com | Password: password | Role: QC Inspector"
    );
    console.log(
      "Email: printing@ashleyai.com | Password: password | Role: Printing Operator"
    );
    console.log(
      "Email: packing@ashleyai.com | Password: password | Role: Packing Operator"
    );
    console.log(
      "Email: supervisor@ashleyai.com | Password: password | Role: Production Supervisor"
    );
    console.log(
      "Email: manager@ashleyai.com | Password: password | Role: Production Manager"
    );
    console.log(
      "Email: warehouse@ashleyai.com | Password: password | Role: Warehouse Staff"
    );
  } catch (error) {
